...
void SkimTree_Event_Jpsi_pp(int nevt=100000, bool isMC = false, int kTrigSel = kTrigJpsipp, int hiHFBinEdge = -1, int PDtype = 1) 
{
...
//  TString fnameDataReReco = "/work2/Oniatree/JPsi/OniaTree_DoubleMuPD_pp2017_5p02TeV_EOY_merged.root";
  TString fnameDataReReco = "/Volumes/home/OniaTree_DoubleMuPD_pp2017_5p02TeV_EOY_merged.root";
...
//  mytree->SetBranchAddress("rpAng", rpAng, &b_rpAng);
  ...
  TFile* newfile;
  newfile = new TFile(Form("OniaFlowSkim_%sTrig_%sPD_pp_isMC%d_221214.root",fTrigName[trigIndx].Data(),fPD.Data(),isMC),"recreate");
