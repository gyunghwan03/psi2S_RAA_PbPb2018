                      ...
                      bool requireRecoMuMatched = true) // always true like PbPb
{
  ...
  if (isPtW)
  {
    ...
    {
      ptWeightMidPaths = {
          Form("%s/ratioDataMC_pp_Jpsi_DATA_ctauCut_y0_2p4_260410.root", hanseulDir.Data()),
      ...
      ptWeightFwdPaths = {
          Form("%s/ratioDataMC_pp_Jpsi_DATA_ctauCut_y1p6_2p4_260410.root", hanseulDir.Data()),
    ...
    {
      ptWeightMidPaths = {
          Form("%s/ratioDataMC_pp_BtoJpsi_DATA_ctauCut_y0_2p4_260410.root", hanseulDir.Data()),
      ...
      ptWeightFwdPaths = {
          Form("%s/ratioDataMC_pp_BtoJpsi_DATA_ctauCut_y1p6_2p4_260410.root", hanseulDir.Data()),
  ...
  std::string outFilePath = Form(
      "%s/mc_eff_vs_pt_rap_%s_pp_Jpsi_PtW%s_tnp%d_260429_1d%s.root",
      outDir.Data(), stateLabel.Data(), ptWeightLabel.Data(), isTnPW ? 1 : 0,
      noPtWeightLabel.Data());
