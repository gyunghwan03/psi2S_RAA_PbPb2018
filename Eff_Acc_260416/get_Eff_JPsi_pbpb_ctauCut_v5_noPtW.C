...
void get_Eff_JPsi_pbpb_ctauCut_v5_noPtW(
    int state = 2,
...
)
{
  ...
  // noPtW: keep weight fixed to 1 and do not load external ratio files.
  TF1 *fptwsys = new TF1("fptwsys", "1.0", 3.0, 50.0);
   ...
   for(int iev=0; iev<nevt; ++iev)
  {
    ...
    for (int igen = 0; igen < Gen_QQ_size; igen++)
    {
      ...
      pt_weight = fptwsys->Eval(JP_Gen->Pt());
      if (JP_Gen->Pt() > 6.5)
    ...
    for (Int_t irqq=0; irqq<Reco_QQ_size; irqq++) 
    {
      ...
      if(isPtWeight){
        ...
        pt_weight = fptwsys->Eval(JP_Reco->Pt());
  ...
  */
  ...
  hpt_eff_0->SetName(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_%0.0f_to_%0.0f_absy0_2p4", isTnP, 0, cLow, cHigh));
  hpt_eff_1->SetName(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_%0.0f_to_%0.0f_absy1p6_2p4", isTnP, 0, cLow, cHigh));
  hpt_eff_2->SetName(Form("mc_eff_vs_pt_TnP%d_PtW%d_cent_%0.0f_to_%0.0f_absy0_1p6  ", isTnP, 0, cLow, cHigh));
  hcent_eff_0->SetName(Form("mc_eff_vs_cent_TnP%d_PtW%d_pt_6p5_to_50_absy0_2p4", isTnP, 0));
  hcent_eff_1->SetName(Form("mc_eff_vs_cent_TnP%d_PtW%d_pt_3_to_40_absy1p6_2p4", isTnP, 0));
  hcent_eff_2->SetName(Form("mc_eff_vs_cent_TnP%d_PtW%d_pt_6p5_to_40_absy0_1p6  ", isTnP, 0));
  hy_eff->SetName(Form("mc_eff_vs_rap_TnP%d_PtW%d", isTnP, 0));
  hInt_eff_1->SetName(Form("mc_eff_Integrated_TnP%d_PtW%d_cent_%0.0f_to_%0.0f_absy1p6_2p4", isTnP, 0, cLow, cHigh));
  hInt_eff_2->SetName(Form("mc_eff_Integrated_TnP%d_PtW%d_cent_%0.0f_to_%0.0f_absy0_1p6  ", isTnP, 0, cLow, cHigh));
  ...
  TString outFileName = Form("./roots/mc_eff_vs_pt_cent_%0.0f_to_%0.0f_rap_prompt_pbpb_JPsi_PtW%s_tnp%d_ctauCut_260310.root", cLow, cHigh, ptSys.Data(), isTnP);
  if (state == 2)
    outFileName = Form("./roots/mc_eff_vs_pt_cent_%0.0f_to_%0.0f_rap_nprompt_pbpb_JPsi_PtW%s_tnp%d_ctauCut_260310.root", cLow, cHigh, ptSys.Data(), isTnP);
