...
void plot_efficiency_ptweight_compare_psi2S_pp(int state = 1) {
  ...
  const TString filePtW = isPrompt
                              ? "./roots/mc_eff_vs_pt_rap_prompt_pp_psi2S_PtW1_tnp1_ctauCut_260416_2exp.root"
                              : "./roots/mc_eff_vs_pt_rap_nprompt_pp_psi2S_PtW1_tnp1_ctauCut_260416_2exp.root";

  const TString fileNoPtW = isPrompt
                                ? "./roots/mc_eff_vs_pt_rap_prompt_pp_psi2S_PtW1_tnp1_ctauCut_260416_noPtW.root"
                                : "./roots/mc_eff_vs_pt_rap_nprompt_pp_psi2S_PtW1_tnp1_ctauCut_260416_noPtW.root";
