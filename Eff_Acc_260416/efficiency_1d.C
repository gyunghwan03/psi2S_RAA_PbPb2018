                   ...
                   bool applyCtauCut = true)
{
  ...
  const std::string weightLabel = Form("_ncollW%d_genW%d_ptW%d_tnpW%d_ctauW%d%s",
  ...
  std::string outFilePath = Form(
      "%s/eff_PbPb2018_isMC1%s%s_Dimuon_MiniAOD_2exp.root",
  ...
  if (applyCtauCut)
  {
    ...
    const TString ctauFilePath = Form("%s/roots_1S_PbPb/ctau3D_cut_ptBin_%sMC_y0.0-2.4.root",
