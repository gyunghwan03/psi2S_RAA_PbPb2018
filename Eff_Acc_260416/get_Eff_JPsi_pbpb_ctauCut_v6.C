...
)
{
  ...
  */
  ...
  TString outFileName;
  if (state == 1 && applyPtWeight) outFileName = Form("./roots/mc_eff_vs_pt_cent_%0.0f_to_%0.0f_rap_prompt_pbpb_JPsi_PtW%s_tnp%d_ctauCut_260416_2exp.root", cLow, cHigh, ptSys.Data(), isTnP);
  else if (state == 1 && !applyPtWeight) outFileName = Form("./roots/mc_eff_vs_pt_cent_%0.0f_to_%0.0f_rap_prompt_pbpb_JPsi_PtW%d_tnp%d_ctauCut_260416_noPtW.root", cLow, cHigh, 1, isTnP);
  else if (state == 2 && applyPtWeight) outFileName = Form("./roots/mc_eff_vs_pt_cent_%0.0f_to_%0.0f_rap_nprompt_pbpb_JPsi_PtW%s_tnp%d_ctauCut_260416_2exp.root", cLow, cHigh, ptSys.Data(), isTnP);
  else if (state == 2 && !applyPtWeight) outFileName = Form("./roots/mc_eff_vs_pt_cent_%0.0f_to_%0.0f_rap_nprompt_pbpb_JPsi_PtW%d_tnp%d_ctauCut_260416_noPtW.root", cLow, cHigh, 1, isTnP);
