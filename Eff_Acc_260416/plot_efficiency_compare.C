...
const TString kPlotOutputDir = "plot_outputs_eff_compare_prev_vs_current";
const TString kPbPbPromptPrevFile = "./roots/mc_eff_vs_pt_cent_0_to_180_rap_prompt_pbpb_JPsi_PtWnomi_tnp1_ctauCut_260310_2exp.root";
const TString kPbPbPromptCurrFile = "./roots/mc_eff_vs_pt_cent_0_to_180_rap_prompt_pbpb_JPsi_PtWnomi_tnp1_ctauCut_260422_v7.root";
const TString kPbPbNonPromptPrevFile = "./roots/mc_eff_vs_pt_cent_0_to_180_rap_nprompt_pbpb_JPsi_PtWnomi_tnp1_ctauCut_260310_2exp.root";
const TString kPbPbNonPromptCurrFile = "./roots/mc_eff_vs_pt_cent_0_to_180_rap_nprompt_pbpb_JPsi_PtWnomi_tnp1_ctauCut_260422_v7.root";
const TString kPrevLabelSuffix = "prev (260310_2exp)";
const TString kCurrLabelSuffix = "v7 (260422)";
const TString kPpPromptPrevFile = "./roots/mc_eff_vs_pt_rap_prompt_pp_Jpsi_PtWnomi_tnp1_ctauCut_260416_2exp.root";
const TString kPpPromptCurrFile = "./roots/mc_eff_vs_pt_rap_prompt_pp_Jpsi_PtWnomi_tnp1_ctauCut_260420_2exp.root";
const TString kPpNonPromptPrevFile = "./roots/mc_eff_vs_pt_rap_nprompt_pp_Jpsi_PtWnomi_tnp1_ctauCut_260416_2exp.root";
const TString kPpNonPromptCurrFile = "./roots/mc_eff_vs_pt_rap_nprompt_pp_Jpsi_PtWnomi_tnp1_ctauCut_260420_2exp.root";
const TString kPpPrevLabelSuffix = "prev (260416_2exp)";
const TString kPpCurrLabelSuffix = "current (260420_2exp)";
...
// Example 1) PbPb J/#psi, forward rapidity, compare previous/current versions
void run_compare_jpsi_pbpb_fwd() {
  std::vector<EffInput> inputs = {
      {kPbPbPromptPrevFile,
       "mc_eff_vs_pt_TnP1_PtW1_cent_0_to_180_absy1p6_2p4",
       Form("Prompt J/#psi PbPb (%s)", kPrevLabelSuffix.Data()), kBlue + 1, 20},
      {kPbPbPromptCurrFile,
       "mc_eff_vs_pt_TnP1_PtW1_cent_0_to_180_absy1p6_2p4",
       Form("Prompt J/#psi PbPb (%s)", kCurrLabelSuffix.Data()), kRed + 1, 21},
  };
...
// Example 2) PbPb J/#psi, mid rapidity, compare previous/current versions
...
void run_compare_jpsi_pbpb_nonprompt_fwd() {
  std::vector<EffInput> inputs = {
      {kPbPbNonPromptPrevFile,
       "mc_eff_vs_pt_TnP1_PtW1_cent_0_to_180_absy1p6_2p4",
       Form("Nonprompt J/#psi PbPb (%s)", kPrevLabelSuffix.Data()), kBlue + 1, 20},
      {kPbPbNonPromptCurrFile,
       "mc_eff_vs_pt_TnP1_PtW1_cent_0_to_180_absy1p6_2p4",
       Form("Nonprompt J/#psi PbPb (%s)", kCurrLabelSuffix.Data()), kRed + 1, 21},
  };
...
void run_compare_jpsi_pp_fwd() {
  std::vector<EffInput> inputs = {
      {kPpPromptPrevFile,
       ...
       Form("Prompt J/#psi pp %s", kPpPrevLabelSuffix.Data()), kBlue + 1, 20},
      {kPpPromptCurrFile,
       "mc_eff_vs_pt_TnP1_PtW1_absy1p6_2p4",
       Form("Prompt J/#psi pp %s", kPpCurrLabelSuffix.Data()), kRed + 1, 21},
  };
...
void run_compare_jpsi_pp_nonprompt_fwd() {
  std::vector<EffInput> inputs = {
      {kPpNonPromptPrevFile,
       "mc_eff_vs_pt_TnP1_PtW1_absy1p6_2p4",
       Form("Nonprompt J/#psi pp %s", kPpPrevLabelSuffix.Data()), kBlue + 1, 20},
      {kPpNonPromptCurrFile,
       "mc_eff_vs_pt_TnP1_PtW1_absy1p6_2p4",
       Form("Nonprompt J/#psi pp %s", kPpCurrLabelSuffix.Data()), kRed + 1, 21},
  };
...
void run_compare_jpsi_pp_fwd_with_integrated_rightpad() {
  draw_pp_with_single_integrated_rightpad("mc_eff_vs_pt_TnP1_PtW1_absy1p6_2p4",
                                          ...
                                          kPpPromptPrevFile,
                                          kPpPromptCurrFile,
                                          Form("Prompt J/#psi pp %s", kPpPrevLabelSuffix.Data()),
                                          Form("Prompt J/#psi pp %s", kPpCurrLabelSuffix.Data()),
                                          kBlue + 1,
                                          kRed + 1,
                                          20,
                                          21);
...
void run_compare_jpsi_pp_nonprompt_fwd_with_integrated_rightpad() {
  draw_pp_with_single_integrated_rightpad("mc_eff_vs_pt_TnP1_PtW1_absy1p6_2p4",
                                          ...
                                          kPpNonPromptPrevFile,
                                          kPpNonPromptCurrFile,
                                          Form("Nonprompt J/#psi pp %s", kPpPrevLabelSuffix.Data()),
                                          Form("Nonprompt J/#psi pp %s", kPpCurrLabelSuffix.Data()),
                                          kBlue + 1,
                                          kRed + 1,
                                          20,
                                          21);
