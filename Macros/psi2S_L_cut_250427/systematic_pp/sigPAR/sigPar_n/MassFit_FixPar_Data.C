    ...
    )
{
  ...
  TString DATE;
  DATE="No_Weight";
  //if(ptLow==6.5&&ptHigh==40) DATE=Form("%i_%i",0,180);
  ...
  if (alpha_lower<0.0) alpha_lower=0.0;
  
  if (xA_higher>1.0) xA_higher=1.0;
  if (xA_lower<0.0) xA_lower=0.0;
