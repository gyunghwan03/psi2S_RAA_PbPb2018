...
do
    ...
    do
    	root -l -b -q 'mc_MassFit_HighpT.C('$pt',1.6,2.4,0,180,'$PRw')'
    done

    for pt in  '6.5,9' '9,12' '12,15' '15,20' '20,25' '25,40'
    do
    	root -l -b -q 'mc_MassFit_HighpT.C('$pt',0,1.6,0,180, '$PRw')'
    done
    #
    for cent in '0,20' '20,40' '40,60' '60,80' '80,100' '100,180'
    do
        root -l -b -q 'mc_MassFit_HighpT.C(6.5,40,0,1.6,'$cent','$PRw')'
    done
    for cent in '0,20' '20,60' '60,100' '100,180'
    do
        root -l -b -q 'mc_MassFit_HighpT.C(3.5,40,1.6,2.4,'$cent','$PRw')'
    done
done
