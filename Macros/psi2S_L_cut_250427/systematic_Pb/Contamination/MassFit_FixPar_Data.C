    ...
    bool fEffW = false, bool fAccW = false, bool isPtW = false, bool isTnP = false)
{
  ...
  if (PRw == 0)
  {
    f2 = new TFile(Form("../../../../ctau_eff/syst/roots_2S_Pb/decayL/PRMC/decay_hist_%s_m3.3-4.1.root", kineLabel.Data()));
    f3 = new TFile(Form("../../../../ctau_eff/syst/roots_2S_Pb/decayL/NPMC/decay_hist_%s_m3.3-4.1.root", kineLabel.Data()));
  ...
  {
    f2 = new TFile(Form("../../../../ctau_eff/syst/roots_2S_Pb/decayL/%sMC/decay_hist_%s_m3.3-4.1.root", fname.Data(), kineLabel.Data()));
  ...
  if (ptLow == 3.5 && cLow == 0 && cHigh == 20 && PRw == 2)
    ...
    sigma_index = 1;
  else if (ptLow==15&&ptHigh==20&&PRw==2) sigma_index=1;
  ...
  else if(ptLow==15&&ptHigh==20&&PRw==2)
  { 
    paramslower[2] = sigma_lower;
    paramsupper[2] = sigma_higher; 
  }
