    ...
    int PRw = 1, bool fEffW = false, bool fAccW = false, bool isPtW = false, bool isTnP = false)
{
  ...
  if (mc_type == 1)
  {
    f2 = new TFile(Form("../../ctau_eff/roots_2S_pp/decayL/PRMC/decay_hist_%s_m3.3-4.1.root", kineLabel.Data()));
    DATE = "PRMC";
  }
  else
  {
    f2 = new TFile(Form("../../ctau_eff/roots_2S_pp/decayL/NPMC/decay_hist_%s_m3.3-4.1.root", kineLabel.Data()));
    DATE = "NPMC";
  }
