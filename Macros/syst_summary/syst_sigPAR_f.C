...
void syst_sigPAR_f()
{
    ...
    string syst_path_pp = "../pp_psi2S_230512/systematic/sigPAR/SigPar_f/roots/2DFit_No_Weight/Final/";
    string syst_path_pb = "../psi2S_230512/systematics/sigPAR/sigPAR_f/roots/2DFit_No_Weight/Final/";
