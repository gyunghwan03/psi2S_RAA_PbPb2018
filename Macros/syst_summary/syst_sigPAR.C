...
void syst_sigPAR()
{
    ...
    string syst_path_pp_alpha = "../pp_psi2S_230512/systematic/sigPAR/SigPar_alpha/roots/2DFit_No_Weight/Final/";
    string syst_path_pb_alpha = "../psi2S_230512/systematics/sigPAR/sigPAR_alpha/roots/2DFit_No_Weight/Final/";
    string syst_path_pp_n = "../pp_psi2S_230512/systematic/sigPAR/SigPar_n/roots/2DFit_No_Weight/Final/";
    string syst_path_pb_n = "../psi2S_230512/systematics/sigPAR/sigPAR_n/roots/2DFit_No_Weight/Final/";
    string syst_path_pp_f = "../pp_psi2S_230512/systematic/sigPAR/SigPar_f/roots/2DFit_No_Weight/Final/";
    string syst_path_pb_f = "../psi2S_230512/systematics/sigPAR/sigPAR_f/roots/2DFit_No_Weight/Final/";
    string syst_path_pp_x = "../pp_psi2S_230512/systematic/sigPAR/SigPar_x/roots/2DFit_No_Weight/Final/";
    string syst_path_pb_x = "../psi2S_230512/systematics/sigPAR/sigPAR_x/roots/2DFit_No_Weight/Final/";
    ...
    for (int i = 0; i < pp_mid_pt.size(); i++) {
        ...
        temp_input_path = syst_path_pp_alpha + pp_mid_pt[i];
        pp_syst_input_alpha = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_alpha + pb_mid_pt[i];
        pb_syst_input_alpha = TFile::Open(temp_input_path.c_str());

        temp_input_path = syst_path_pp_n + pp_mid_pt[i];
        pp_syst_input_n = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_n + pb_mid_pt[i];
        pb_syst_input_n = TFile::Open(temp_input_path.c_str());

        temp_input_path = syst_path_pp_f + pp_mid_pt[i];
        pp_syst_input_f = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_f + pb_mid_pt[i];
        pb_syst_input_f = TFile::Open(temp_input_path.c_str());

        temp_input_path = syst_path_pp_x + pp_mid_pt[i];
        pp_syst_input_x = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_x + pb_mid_pt[i];
    ...
    for (int i = 0; i < pp_fwd_pt.size(); i++) {
        ...
        temp_input_path = syst_path_pp_alpha + pp_fwd_pt[i];
        pp_syst_input_alpha = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_alpha + pb_fwd_pt[i];
        pb_syst_input_alpha = TFile::Open(temp_input_path.c_str());

        temp_input_path = syst_path_pp_n + pp_fwd_pt[i];
        pp_syst_input_n = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_n + pb_fwd_pt[i];
        pb_syst_input_n = TFile::Open(temp_input_path.c_str());

        temp_input_path = syst_path_pp_f + pp_fwd_pt[i];
        pp_syst_input_f = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_f + pb_fwd_pt[i];
        pb_syst_input_f = TFile::Open(temp_input_path.c_str());

        temp_input_path = syst_path_pp_x + pp_fwd_pt[i];
        pp_syst_input_x = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_x + pb_fwd_pt[i];
        pb_syst_input_x = TFile::Open(temp_input_path.c_str());
    ...
    for (int i = 0; i < pb_mid_cent.size(); i++) {
        ...
        temp_input_path = syst_path_pp_alpha + pp_mid_cent[0];
        pp_syst_input_alpha = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_alpha + pb_mid_cent[i];
        pb_syst_input_alpha = TFile::Open(temp_input_path.c_str());

        temp_input_path = syst_path_pp_n + pp_mid_cent[0];
        pp_syst_input_n = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_n + pb_mid_cent[i];
        pb_syst_input_n = TFile::Open(temp_input_path.c_str());

        temp_input_path = syst_path_pp_f + pp_mid_cent[0];
        pp_syst_input_f = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_f + pb_mid_cent[i];
        pb_syst_input_f = TFile::Open(temp_input_path.c_str());

        temp_input_path = syst_path_pp_x + pp_mid_cent[0];
        pp_syst_input_x = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_x + pb_mid_cent[i];
        pb_syst_input_x = TFile::Open(temp_input_path.c_str());
    ...
    for (int i = 0; i < pb_fwd_cent.size(); i++) {
        ...
        temp_input_path = syst_path_pp_alpha + pp_fwd_cent[0];
        pp_syst_input_alpha = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_alpha + pb_fwd_cent[i];
        pb_syst_input_alpha = TFile::Open(temp_input_path.c_str());

        temp_input_path = syst_path_pp_n + pp_fwd_cent[0];
        pp_syst_input_n = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_n + pb_fwd_cent[i];
        pb_syst_input_n = TFile::Open(temp_input_path.c_str());

        temp_input_path = syst_path_pp_f + pp_fwd_cent[0];
        pp_syst_input_f = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_f + pb_fwd_cent[i];
        pb_syst_input_f = TFile::Open(temp_input_path.c_str());

        temp_input_path = syst_path_pp_x + pp_fwd_cent[0];
        pp_syst_input_x = TFile::Open(temp_input_path.c_str());
        temp_input_path = syst_path_pb_x + pb_fwd_cent[i];
        pb_syst_input_x = TFile::Open(temp_input_path.c_str());
