...
void syst_sigPAR_alpha()
{
    gSystem->mkdir("syst_roots");
    string syst_type = "sigPAR_alpha";
    ...
    string syst_path_pp = "../pp_psi2S_230512/systematic/sigPAR/SigPar_alpha/roots/2DFit_No_Weight/Final/";
    string syst_path_pb = "../psi2S_230512/systematics/sigPAR/sigPAR_alpha/roots/2DFit_No_Weight/Final/";
