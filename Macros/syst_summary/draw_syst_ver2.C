...
void draw_syst()
{
	...
	h_mid_cent_PR_pb[6] = new TH1D("mid_PR_pb","mid_PR_pb",NcentBins,centBin);
	h_mid_cent_NP[6] = new TH1D("mid_NP","mid_NP",NcentBins,centBin);
	h_mid_cent_NP_pb[6] = new TH1D("mid_NP_pb","mid_NP_pb",NcentBins,centBin);
	h_fwd_cent_PR[6] = new TH1D("fwd_PR","fwd_PR",NcentBins,centBin);
	h_fwd_cent_PR_pb[6] = new TH1D("fwd_PR_pb","fwd_PR_pb",NcentBins,centBin);
	h_fwd_cent_NP[6] = new TH1D("fwd_NP","fwd_NP",NcentBins,centBin);
	h_fwd_cent_NP_pb[6] = new TH1D("fwd_NP_pb","fwd_NP_pb",NcentBins,centBin);

	for(int i=1; i<NcentBins+1; i++)
	{
		h_mid_cent_PR[6]->SetBinContent(i, ((TH1D*) in_cent[6]->Get("mid_PR"))->GetBinContent(i));
		h_mid_cent_PR_pb[6]->SetBinContent(i, ((TH1D*) in_cent[6]->Get("mid_PR_pb"))->GetBinContent(i));
		h_mid_cent_NP[6]->SetBinContent(i, ((TH1D*) in_cent[6]->Get("mid_NP"))->GetBinContent(i));
		h_mid_cent_NP_pb[6]->SetBinContent(i, ((TH1D*) in_cent[6]->Get("mid_NP_pb"))->GetBinContent(i));
		h_fwd_cent_PR[6]->SetBinContent(i, ((TH1D*) in_cent[6]->Get("fwd_PR"))->GetBinContent(i));
		h_fwd_cent_PR_pb[6]->SetBinContent(i, ((TH1D*) in_cent[6]->Get("fwd_PR_pb"))->GetBinContent(i));
		h_fwd_cent_NP[6]->SetBinContent(i, ((TH1D*) in_cent[6]->Get("fwd_NP"))->GetBinContent(i));
		h_fwd_cent_NP_pb[6]->SetBinContent(i, ((TH1D*) in_cent[6]->Get("fwd_NP_pb"))->GetBinContent(i));
	}
	...
	for (int i=0; i<nFiles; i++) {
		...
		leg_midptPR->AddEntry(h_mid_pt_PR_pp[i],SysName[i]);
		leg_midptPR->Draw("SAME");
	}
	drawText("Prompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	...
	for (int i=0; i<nFiles; i++) {
		...
		leg_midptPR->AddEntry(h_mid_pt_PR_pb[i],SysName[i]);
		leg_midptPR->Draw("SAME");
	}
	drawText("Prompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	...
	for (int i=0; i<nFiles; i++) {
		...
		leg_midptNP->AddEntry(h_mid_pt_NP_pp[i],SysName[i]);
		leg_midptNP->Draw("SAME");
	}	
	drawText("NonPrompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	...
	for (int i=0; i<nFiles; i++) {
		...
		leg_midptNP->AddEntry(h_mid_pt_NP_pb[i],SysName[i]);
		leg_midptNP->Draw("SAME");
	}	
	drawText("NonPrompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
