...
void compute_total_syst()
{
    ...
    auto h_acc_fwd_pt_PR = (TH1D*) in_acc_pt->Get("fwd");
    ...
    auto h_acc_fwd_pt_NP = (TH1D*) in_acc_pt->Get("fwd");
    ...
    for (int hist_idx = 1; hist_idx < NBINS_mid_cent+1; hist_idx++) {
        ...
        double TNP_PR = h_TNP_mid_cent_PR->GetBinContent(hist_idx);
        ...
        double TNP_NP = h_TNP_mid_cent_NP->GetBinContent(hist_idx);
    ...
    for (int hist_idx = 1; hist_idx < NBINS_fwd_cent+1; hist_idx++) {
        ...
        double TNP_PR = h_TNP_fwd_cent_PR->GetBinContent(hist_idx);
        ...
        double TNP_NP = h_TNP_fwd_cent_NP->GetBinContent(hist_idx);
