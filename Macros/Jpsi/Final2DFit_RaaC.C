    ...
    )
{
  ...
  else fCTrue = new TFile(Form("roots/2DFit_%s/CtauTrue/cent/CtauTrueResult_Inclusive_%s.root","No_Weight", kineLabel.Data()));
...
//  ctauErrMax = 0.06;}//0.124872
  ...
  if(ptLow==6.5 && ptHigh==40 && cLow==0) ws->factory("b_Jpsi[0.38, 0.36, 0.43]");//NP fraction for Sig
