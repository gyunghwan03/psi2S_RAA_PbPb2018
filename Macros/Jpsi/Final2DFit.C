    ...
    )
{
  ...
  if(ptLow==3.&&ptHigh==40) fCTrue = new TFile(Form("roots/2DFit_%s/CtauTrue/CtauTrueResult_Inclusive_pt3.0-40.0_y1.6-2.4_muPt0.0_centrality0-180.root",DATE.Data()));
...
//  ctauErrMax = 0.06;}//0.124872
  ...
  if(ptLow==6.5 && ptHigh==40 && cLow==100) ws->factory("b_Jpsi[0.372, 0.36, 0.38]");//NP fraction for Sig
