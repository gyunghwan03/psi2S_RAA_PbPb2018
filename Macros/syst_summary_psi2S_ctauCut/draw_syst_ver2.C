...
void draw_syst_ver2()
{
	...
	TString SysName[nFiles] = {"Total", "Sig. PDF","Sig. Par","Bkg. PDF", "HF", "TNP", "Eff", "Acc"}; //, "b Fraction", "Eff"};
	...
	in_pt[5] = TFile::Open("syst_roots/syst_pt_TNP.root"); // TnP PbPb only
	in_pt[6] = TFile::Open("syst_roots/syst_pt_Eff.root");
	in_pt[7] = TFile::Open("syst_roots/syst_pt_acc.root");
	in_pt[8] = TFile::Open("syst_roots/syst_pt_TNP_pp.root"); // TnP pp only
	...
	in_cent[5] = TFile::Open("syst_roots/syst_cent_TNP.root"); // TnP PbPb only
	in_cent[6] = TFile::Open("syst_roots/syst_cent_Eff.root");	
	in_cent[7] = TFile::Open("syst_roots/syst_cent_acc.root");
	in_cent[8] = TFile::Open("syst_roots/syst_cent_TNP_pp.root"); // TnP pp only
	...
	h_mid_pt_PR_pp[5] = (TH1D*) in_pt[8]->Get("mid_PR");
	h_mid_pt_PR_pb[5] = (TH1D*) in_pt[5]->Get("mid_PR");
	//h_mid_pt_NP[6] = (TH1D*) in_pt[6]->Get("mid_NP");
	h_mid_pt_NP_pp[5] = (TH1D*) in_pt[8]->Get("mid_NP");
	h_mid_pt_NP_pb[5] = (TH1D*) in_pt[5]->Get("mid_NP");
	//h_fwd_pt_PR[6] = (TH1D*) in_pt[6]->Get("fwd_PR");
	h_fwd_pt_PR_pp[5] = (TH1D*) in_pt[8]->Get("fwd_PR");
	h_fwd_pt_PR_pb[5] = (TH1D*) in_pt[5]->Get("fwd_NP");
	//h_fwd_pt_NP[6] = (TH1D*) in_pt[6]->Get("fwd_NP");
	h_fwd_pt_NP_pp[5] = (TH1D*) in_pt[8]->Get("fwd_NP");
	h_fwd_pt_NP_pb[5] = (TH1D*) in_pt[5]->Get("fwd_NP");
	//h_mid_cent_PR[6] = (TH1D*) in_cent[6]->Get("mid_PR");
	h_mid_cent_PR_pp[5] = (TH1D*) in_cent[8]->Get("mid_PR");
	h_mid_cent_PR_pb[5] = (TH1D*) in_cent[5]->Get("mid_PR");
	//h_mid_cent_NP[6] = (TH1D*) in_cent[6]->Get("mid_NP");
	h_mid_cent_NP_pp[5] = (TH1D*) in_cent[8]->Get("mid_NP");
	h_mid_cent_NP_pb[5] = (TH1D*) in_cent[5]->Get("mid_NP");
	//h_fwd_cent_PR[6] = (TH1D*) in_cent[6]->Get("fwd_PR");
	h_fwd_cent_PR_pp[5] = (TH1D*) in_cent[8]->Get("fwd_PR");
	h_fwd_cent_PR_pb[5] = (TH1D*) in_cent[5]->Get("fwd_PR");
	//h_fwd_cent_NP[6] = (TH1D*) in_cent[6]->Get("fwd_NP");
	h_fwd_cent_NP_pp[5] = (TH1D*) in_cent[8]->Get("fwd_NP");
	h_fwd_cent_NP_pb[5] = (TH1D*) in_cent[5]->Get("fwd_NP");

	h_mid_pt_PR[7] = (TH1D*) in_pt[7]->Get("mid"); //Acc
	h_mid_pt_PR_pp[7] = (TH1D*) in_pt[7]->Get("mid_pp"); //Acc
	h_mid_pt_PR_pb[7] = (TH1D*) in_pt[7]->Get("mid_pb"); //Acc
	h_mid_pt_NP[7] = (TH1D*) in_pt[7]->Get("mid"); //Acc
	h_mid_pt_NP_pp[7] = (TH1D*) in_pt[7]->Get("mid_pp"); //Acc
	h_mid_pt_NP_pb[7] = (TH1D*) in_pt[7]->Get("mid_pb"); //Acc
	h_fwd_pt_PR[7] = (TH1D*) in_pt[7]->Get("fwd"); //Acc
	h_fwd_pt_PR_pp[7] = (TH1D*) in_pt[7]->Get("fwd_pp"); //Acc
	h_fwd_pt_PR_pb[7] = (TH1D*) in_pt[7]->Get("fwd_pb"); //Acc
	h_fwd_pt_NP[7] = (TH1D*) in_pt[7]->Get("fwd"); //Acc
	h_fwd_pt_NP_pp[7] = (TH1D*) in_pt[7]->Get("fwd_pp"); //Acc
	h_fwd_pt_NP_pb[7] = (TH1D*) in_pt[7]->Get("fwd_pb"); //Acc
	h_mid_cent_PR[7] = (TH1D*) in_cent[7]->Get("mid");
	h_mid_cent_PR_pp[7] = (TH1D*) in_cent[7]->Get("mid_pp");
	h_mid_cent_PR_pb[7] = (TH1D*) in_cent[7]->Get("mid_pb");
	h_mid_cent_NP[7] = (TH1D*) in_cent[7]->Get("mid");
	h_mid_cent_NP_pp[7] = (TH1D*) in_cent[7]->Get("mid_pp");
	h_mid_cent_NP_pb[7] = (TH1D*) in_cent[7]->Get("mid_pb");
	h_fwd_cent_PR[7] = (TH1D*) in_cent[7]->Get("fwd");
	h_fwd_cent_PR_pp[7] = (TH1D*) in_cent[7]->Get("fwd_pp");
	h_fwd_cent_PR_pb[7] = (TH1D*) in_cent[7]->Get("fwd_pb");
	h_fwd_cent_NP[7] = (TH1D*) in_cent[7]->Get("fwd");
	h_fwd_cent_NP_pp[7] = (TH1D*) in_cent[7]->Get("fwd_pp");
	h_fwd_cent_NP_pb[7] = (TH1D*) in_cent[7]->Get("fwd_pb");

	
	const int NcentBinsMid = 6;
	const int NcentBinsFwd = 4;
	double centBinMid[NcentBinsMid+1] = {0,10,20,30,40,50,90};
	double centBinFwd[NcentBinsFwd+1] = {0, 10, 30, 50, 90};
	h_mid_cent_PR[5] = new TH1D("mid_PR","mid_PR",NcentBinsMid,centBinMid);
	h_mid_cent_NP[5] = new TH1D("mid_NP","mid_NP",NcentBinsMid,centBinMid);
	
	h_fwd_cent_PR[5] = new TH1D("fwd_PR","fwd_PR",NcentBinsFwd,centBinFwd);
	h_fwd_cent_NP[5] = new TH1D("fwd_NP","fwd_NP",NcentBinsFwd,centBinFwd);
	...
	h_mid_pt_PR[5] = new TH1D("mid_PR","mid_PR",NptBinsMid,ptBinMid);
	h_mid_pt_NP[5] = new TH1D("mid_NP","mid_NP",NptBinsMid,ptBinMid);
	h_fwd_pt_PR[5] = new TH1D("fwd_PR","fwd_PR",NptBinsFwd,ptBinFwd);
	h_fwd_pt_NP[5] = new TH1D("fwd_NP","fwd_NP",NptBinsFwd,ptBinFwd);

	for(int i=1; i<NptBinsMid+1; i++) {
		// pt
		double TnP_pb = h_mid_pt_PR_pb[5]->GetBinContent(i+1);
		double TnP_pp = h_mid_pt_PR_pp[5]->GetBinContent(i+1); // pp input has one TnP bin
		double TnP_tot = TMath::Sqrt(TMath::Power(TnP_pb,2) + TMath::Power(TnP_pp,2) ); 
		h_mid_pt_PR[5]->SetBinContent(i, TnP_tot);
		
		TnP_pb = h_mid_pt_NP_pb[5]->GetBinContent(i+1);
		TnP_pp = h_mid_pt_NP_pp[5]->GetBinContent(1); // pp input has one TnP bin
		TnP_tot = TMath::Sqrt(TMath::Power(TnP_pb,2) + TMath::Power(TnP_pp,2) ); 
		h_mid_pt_NP[5]->SetBinContent(i, TnP_tot);
	}
		
	for(int i=1; i<NptBinsFwd+1; i++) {
		double TnP_pb = h_fwd_pt_PR_pb[5]->GetBinContent(i+1);
		double TnP_pp = h_fwd_pt_PR_pp[5]->GetBinContent(i+1); // pp input has one TnP bin
		double TnP_tot = TMath::Sqrt(TMath::Power(TnP_pb,2) + TMath::Power(TnP_pp,2) ); 
		h_fwd_pt_PR[5]->SetBinContent(i, TnP_tot);
		
		TnP_pb = h_fwd_pt_NP_pb[5]->GetBinContent(i+1);
		TnP_pp = h_fwd_pt_NP_pp[5]->GetBinContent(i+1); // pp input has one TnP bin
		TnP_tot = TMath::Sqrt(TMath::Power(TnP_pb,2) + TMath::Power(TnP_pp,2) ); 
		h_fwd_pt_NP[5]->SetBinContent(i, TnP_tot);
	    cout << "TnP Pb : " << TnP_pb << "\t, TnP pp : " << TnP_pp << "\t, Total : " << TnP_tot << endl;
	}

	for(int i=1; i<NcentBinsMid+1; i++) {
		// cent
		double TnP_pb = h_mid_cent_PR_pb[5]->GetBinContent(i);
		double TnP_pp = h_mid_cent_PR_pp[5]->GetBinContent(1); // pp input has one TnP bin
		double TnP_tot = TMath::Sqrt(TMath::Power(TnP_pb,2) + TMath::Power(TnP_pp,2) ); 
		h_mid_cent_PR[5]->SetBinContent(i, TnP_tot);
		
		TnP_pb = h_mid_cent_NP_pb[5]->GetBinContent(i);
		TnP_pp = h_mid_cent_NP_pp[5]->GetBinContent(1); // pp input has one TnP bin
		TnP_tot = TMath::Sqrt(TMath::Power(TnP_pb,2) + TMath::Power(TnP_pp,2) ); 
		cout << "pb TnP : " << TnP_pb << ", pp TnP : " << TnP_pp << ", Total : " << TnP_tot << endl;
		h_mid_cent_NP[5]->SetBinContent(i, TnP_tot);
	}
	for(int i=1; i<NcentBinsFwd+1; i++) {
		double TnP_pb = h_fwd_cent_PR_pb[5]->GetBinContent(i);
		double TnP_pp = h_fwd_cent_PR_pp[5]->GetBinContent(1); // pp input has one TnP bin
		double TnP_tot = TMath::Sqrt(TMath::Power(TnP_pb,2) + TMath::Power(TnP_pp,2) ); 
		//cout << "pb TnP : " << TnP_pb << ", pp TnP : " << TnP_pp << ", Total : " << TnP_tot << endl;
		h_fwd_cent_PR[5]->SetBinContent(i, TnP_tot);
		//cout << "lower : " << h_fwd_cent_PR[6]->GetXaxis()->GetBinLowEdge(i) << ", upper : " <<  h_fwd_cent_PR[6]->GetXaxis()->GetBinUpEdge(i) << endl;
		
		TnP_pb = h_fwd_cent_NP_pb[5]->GetBinContent(i);
		TnP_pp = h_fwd_cent_NP_pp[5]->GetBinContent(1); // pp input has one TnP bin
		TnP_tot = TMath::Sqrt(TMath::Power(TnP_pb,2) + TMath::Power(TnP_pp,2) ); 
		h_fwd_cent_NP[5]->SetBinContent(i, TnP_tot);
	}
	...
	TLegend *leg_midptPR = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_midptPR);
	TLegend *leg_midptPR_pp = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_midptPR_pp);
	TLegend *leg_midptPR_pb = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_midptPR_pb);
	TLegend *leg_midptNP = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_midptNP);
	TLegend *leg_midptNP_pp = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_midptNP_pp);
	TLegend *leg_midptNP_pb = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_midptNP_pb);
	TLegend *leg_fwdptPR = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_fwdptPR);
	TLegend *leg_fwdptPR_pp = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_fwdptPR_pp);
	TLegend *leg_fwdptPR_pb = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_fwdptPR_pb);
	TLegend *leg_fwdptNP = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_fwdptNP);
	TLegend *leg_fwdptNP_pp = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_fwdptNP_pp);
	TLegend *leg_fwdptNP_pb = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_fwdptNP_pb);
	TLegend *leg_midcentPR = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_midcentPR);
	TLegend *leg_midcentPR_pp = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_midcentPR_pp);
	TLegend *leg_midcentPR_pb = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_midcentPR_pb);
	TLegend *leg_midcentNP = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_midcentNP);
	TLegend *leg_midcentNP_pp = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_midcentNP_pp);
	TLegend *leg_midcentNP_pb = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_midcentNP_pb);
	TLegend *leg_fwdcentPR = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_fwdcentPR);
	TLegend *leg_fwdcentPR_pp = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_fwdcentPR_pp);
	TLegend *leg_fwdcentPR_pb = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_fwdcentPR_pb);
	TLegend *leg_fwdcentNP = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_fwdcentNP);
	TLegend *leg_fwdcentNP_pp = new TLegend(0.48,0.70,0.7,0.90);
    SetLegendStyle(leg_fwdcentNP_pp);
	TLegend *leg_fwdcentNP_pb = new TLegend(0.48,0.70,0.7,0.90);
	...
	h_mid_pt_PR_pp[0]->SetLineWidth(3);
	drawText("Prompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("Cent. 0-90%", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_mid_pt_PR_pb[0]->SetLineWidth(3);
	drawText("Prompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("Cent. 0-90%", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_mid_pt_NP_pp[0]->SetLineWidth(3);
	drawText("Nonprompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("Cent. 0-90%", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_mid_pt_NP_pb[0]->SetLineWidth(3);
	drawText("Nonprompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("Cent. 0-90%", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	for (int i=0; i<nFiles-1; i++) {
		...
		//cout << SysName[i] << " : " << h_fwd_pt_PR[i]->GetBinContent(2) << endl; 
	}
	h_fwd_pt_PR[0]->SetLineWidth(3);
	drawText("Prompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	...
	h_fwd_pt_PR_pp[0]->SetLineWidth(3);
	drawText("Prompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("1.6 < |y| < 2.4", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("Cent. 0-90%", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	for (int i=0; i<nFiles-1; i++) {
		...
		cout << SysName[i] << " : " << h_fwd_pt_PR_pb[i]->GetBinContent(2) << endl;

		leg_fwdptPR_pb->AddEntry(h_fwd_pt_PR_pb[i],SysName[i]);
		leg_fwdptPR_pb->Draw("SAME");
	}
	h_fwd_pt_PR_pb[0]->SetLineWidth(3);
	drawText("Prompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("1.6 < |y| < 2.4", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("Cent. 0-90%", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_fwd_pt_NP_pp[0]->SetLineWidth(3);
	drawText("Nonprompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("1.6 < |y| < 2.4", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("Cent. 0-90%", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_fwd_pt_NP_pb[0]->SetLineWidth(3);
	drawText("Nonprompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("1.6 < |y| < 2.4", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("Cent. 0-90%", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_mid_cent_PR[0]->SetLineWidth(3);
	drawText("Prompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	...
	h_mid_cent_PR_pb[0]->SetLineWidth(3);
	drawText("Prompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("6.5 < p_{T} < 40 GeV/c", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_mid_cent_PR_pp[0]->SetLineWidth(3);
	drawText("Prompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("6.5 < p_{T} < 40 GeV/c", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_mid_cent_NP[0]->SetLineWidth(3);
	drawText("Nonprompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("6.5 < p_{T} < 40 GeV/c", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_mid_cent_NP_pb[0]->SetLineWidth(3);
	drawText("Nonprompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("6.5 < p_{T} < 40 GeV/c", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_mid_cent_NP_pp[0]->SetLineWidth(3);
	drawText("Nonprompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("6.5 < p_{T} < 40 GeV/c", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_fwd_cent_PR[0]->SetLineWidth(3);
	drawText("Prompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("1.6 < |y| < 2.4", pos_x, pos_y-pos_y_diff, text_color, text_size);
	...
	h_fwd_cent_PR_pb[0]->SetLineWidth(3);
	drawText("Prompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("1.6 < |y| < 2.4", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("3.5 < p_{T} < 40 GeV/c", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_fwd_cent_PR_pp[0]->SetLineWidth(3);
	drawText("Prompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("1.6 < |y| < 2.4", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("3.5 < p_{T} < 40 GeV/c", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_fwd_cent_NP[0]->SetLineWidth(3);
	drawText("Nonprompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("1.6 < |y| < 2.4", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("3.5 < p_{T} < 40 GeV/c", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_fwd_cent_NP_pb[0]->SetLineWidth(3);
	drawText("Nonprompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("1.6 < |y| < 2.4", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("3.5 < p_{T} < 40 GeV/c", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	h_fwd_cent_NP_pp[0]->SetLineWidth(3);
	drawText("Nonprompt #psi(2S)", pos_x, pos_y, text_color, text_size*1.3);
	drawText("1.6 < |y| < 2.4", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("3.5 < p_{T} < 40 GeV/c", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
