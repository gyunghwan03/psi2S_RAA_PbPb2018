...
void compute_DoubleRatio_syst()
{
    ...
    for (int hist_idx = 1; hist_idx < NBINS_mid_pt+1; hist_idx++) {
        ...
        double bFrac_PR_pp = 0; //h_bFrac_mid_pt_PR_pp->GetBinContent(hist_idx);
        ...
        double bFrac_PR_pb = 0; //h_bFrac_mid_pt_PR_pb->GetBinContent(hist_idx);
        ...
        double bFrac_PR = 0; //h_bFrac_mid_pt_PR->GetBinContent(hist_idx);
        ...
        double bFrac_NP_pp = 0; //h_bFrac_mid_pt_NP_pp->GetBinContent(hist_idx);
        ...
        double bFrac_NP_pb = 0; //h_bFrac_mid_pt_NP_pb->GetBinContent(hist_idx);
        ...
        double bFrac_NP = 0; //h_bFrac_mid_pt_NP->GetBinContent(hist_idx);
    ...
    for (int hist_idx = 1; hist_idx < NBINS_fwd_pt+1; hist_idx++) {
        ...
        double bFrac_PR_pp = 0; //h_bFrac_fwd_pt_PR_pp->GetBinContent(hist_idx);
        ...
        double bFrac_PR_pb = 0; //h_bFrac_fwd_pt_PR_pb->GetBinContent(hist_idx);
        ...
        double bFrac_PR = 0; //h_bFrac_fwd_pt_PR->GetBinContent(hist_idx);
        ...
        double bFrac_NP_pp = 0; //h_bFrac_fwd_pt_NP_pp->GetBinContent(hist_idx);
        ...
        double bFrac_NP_pb = 0; //h_bFrac_fwd_pt_NP_pb->GetBinContent(hist_idx);
        ...
        double bFrac_NP = 0; //h_bFrac_fwd_pt_NP->GetBinContent(hist_idx);
    ...
    for (int hist_idx = 1; hist_idx < NBINS_mid_cent+1; hist_idx++) {
        ...
        double bFrac_PR_pp = 0; //h_bFrac_mid_cent_PR_pp->GetBinContent(hist_idx);
        ...
        double bFrac_PR_pb = 0; //h_bFrac_mid_cent_PR_pb->GetBinContent(hist_idx);
        ...
        double bFrac_PR = 0; //h_bFrac_mid_cent_PR->GetBinContent(hist_idx);
        ...
        double bFrac_NP_pp = 0; //h_bFrac_mid_cent_NP_pp->GetBinContent(hist_idx);
        ...
        double bFrac_NP_pb =  0; //h_bFrac_mid_cent_NP_pb->GetBinContent(hist_idx);
        ...
        double bFrac_NP = 0; // h_bFrac_mid_cent_NP->GetBinContent(hist_idx);
    ...
    for (int hist_idx = 1; hist_idx < NBINS_fwd_cent+1; hist_idx++) {
        ...
        double bFrac_PR_pp = 0; //h_bFrac_fwd_cent_PR_pp->GetBinContent(hist_idx);
        ...
        double bFrac_PR_pb = 0; //h_bFrac_fwd_cent_PR_pb->GetBinContent(hist_idx);
        ...
        double bFrac_PR = 0; //h_bFrac_fwd_cent_PR->GetBinContent(hist_idx);
        ...
        double bFrac_NP_pp = 0; //h_bFrac_fwd_cent_NP_pp->GetBinContent(hist_idx);
        ...
        double bFrac_NP_pb = 0; //h_bFrac_fwd_cent_NP_pb->GetBinContent(hist_idx);
        ...
        double bFrac_NP = 0; //h_bFrac_fwd_cent_NP->GetBinContent(hist_idx);
