...
void compute_total_syst()
{
    ...
    for (int hist_idx = 1; hist_idx < NBINS_mid_pt+1; hist_idx++) {
        ...
        double acc_PR_pp = h_acc_mid_pt_PR->GetBinContent(hist_idx);
		...
		cout << "################ pp PR ################" << endl;
		cout << "sigPDF :	" << sigPDF_PR_pp << ", sigPAR :	" << sigPAR_PR_pp << ",	bkgPDF :	" << bkgPDF_PR_pp << ",	bFrac :	" << bFrac_PR_pp << ",	acc :	" << acc_PR_pp << ",	Eff :	" << eff_PR_pp << ",	TnP :	" << TNP_PR_pp << endl;
        ...
        double acc_PR_pb = h_acc_mid_pt_PR->GetBinContent(hist_idx);
        ...
        double acc_NP_pp = h_acc_mid_pt_NP->GetBinContent(hist_idx);
        ...
        double acc_NP_pb = h_acc_mid_pt_NP->GetBinContent(hist_idx);
    ...
    for (int hist_idx = 1; hist_idx < NBINS_fwd_pt+1; hist_idx++) {
        ...
        double acc_PR_pp = h_acc_fwd_pt_PR->GetBinContent(hist_idx);
        ...
        double acc_PR_pb = h_acc_fwd_pt_PR->GetBinContent(hist_idx);
        ...
        double acc_NP_pp = h_acc_fwd_pt_NP->GetBinContent(hist_idx);
        ...
        double acc_NP_pb = h_acc_fwd_pt_NP->GetBinContent(hist_idx);
    ...
    for (int hist_idx = 1; hist_idx < NBINS_mid_cent+1; hist_idx++) {
        ...
        double acc_PR_pp = h_acc_mid_cent_PR->GetBinContent(hist_idx);
        ...
        double acc_NP_pp = h_acc_mid_cent_NP->GetBinContent(hist_idx);
        ...
        double acc_NP_pb = h_acc_mid_cent_NP->GetBinContent(hist_idx);
    ...
    for (int hist_idx = 1; hist_idx < NBINS_fwd_cent+1; hist_idx++) {
        ...
        double acc_PR_pp = h_acc_fwd_cent_PR->GetBinContent(hist_idx);
        ...
        double acc_NP_pp = h_acc_fwd_cent_NP->GetBinContent(hist_idx);
        ...
        double acc_NP_pb = h_acc_fwd_cent_NP->GetBinContent(hist_idx);
