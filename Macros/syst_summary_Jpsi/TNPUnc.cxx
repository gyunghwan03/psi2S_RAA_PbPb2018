...
std::pair<string, string> get_histnames(bool get_pbpb, bool isPR, bool isFwd, float ptLow, float ptHigh, int cbinLow, int cbinHigh ){
	string name_ref ="";
	if( isPR && get_pbpb ) name_ref = "../../Eff_Acc/roots/mc_eff_vs_pt_cent_0_to_180_rap_prompt_pbpb_psi2s_PtW1_tnp1_20230607.root";
	if(!isPR && get_pbpb) name_ref = "../../Eff_Acc/roots/mc_eff_vs_pt_cent_0_to_180_rap_nprompt_pbpb_psi2S_PtW1_tnp1_new_20230607.root";
	string name_cmp="";
	double yl, yh;
...
void TNPUnc(bool incl_pp, bool incl_pbpb, bool dopt){
	...
	const size_t numbin_for =  (dopt) ? 5 : 6;
	const size_t numbin_mid =  (dopt) ? 8 : 6;
	double ptBin_for[6] = {0,3.5,5,6.5,12,50};
    double ptBin_mid[9] = {0,6.5,9,12,15,20,25,30,50};
    double centBin_for[7] = {0,20,40,60,80,100,181};
	double centBin_mid[7] = {0,20,40,60,80,100,181};
