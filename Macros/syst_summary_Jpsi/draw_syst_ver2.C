...
void draw_syst_ver2()
{
	...
	h_mid_pt_PR[8] = (TH1D*) in_pt[8]->Get("mid_PR"); //Acc
	h_mid_pt_PR_pp[8] = (TH1D*) in_pt[8]->Get("mid_PR"); //Acc
	h_mid_pt_PR_pb[8] = (TH1D*) in_pt[8]->Get("mid_PR"); //Acc
	h_fwd_pt_PR[8] = (TH1D*) in_pt[8]->Get("fwd_PR"); //Acc
	h_fwd_pt_PR_pp[8] = (TH1D*) in_pt[8]->Get("fwd_PR"); //Acc
	h_fwd_pt_PR_pb[8] = (TH1D*) in_pt[8]->Get("fwd_PR"); //Acc
	h_mid_pt_NP[8] = (TH1D*) in_pt[8]->Get("mid_NP"); //Acc
	h_mid_pt_NP_pp[8] = (TH1D*) in_pt[8]->Get("mid_NP"); //Acc
	h_mid_pt_NP_pb[8] = (TH1D*) in_pt[8]->Get("mid_NP"); //Acc
	h_fwd_pt_NP[8] = (TH1D*) in_pt[8]->Get("fwd_NP"); //Acc
	h_fwd_pt_NP_pp[8] = (TH1D*) in_pt[8]->Get("fwd_NP"); //Acc
	h_fwd_pt_NP_pb[8] = (TH1D*) in_pt[8]->Get("fwd_NP"); //Acc
	h_mid_cent_PR[8] = (TH1D*) in_cent[8]->Get("mid_PR");
	h_mid_cent_PR_pp[8] = (TH1D*) in_cent[8]->Get("mid_PR");
	h_mid_cent_PR_pb[8] = (TH1D*) in_cent[8]->Get("mid_PR");
	h_mid_cent_NP[8] = (TH1D*) in_cent[8]->Get("mid_NP");
	h_mid_cent_NP_pp[8] = (TH1D*) in_cent[8]->Get("mid_NP");
	h_mid_cent_NP_pb[8] = (TH1D*) in_cent[8]->Get("mid_NP");
	h_fwd_cent_PR[8] = (TH1D*) in_cent[8]->Get("fwd_PR");
	h_fwd_cent_PR_pp[8] = (TH1D*) in_cent[8]->Get("fwd_PR");
	h_fwd_cent_PR_pb[8] = (TH1D*) in_cent[8]->Get("fwd_PR");
	h_fwd_cent_NP[8] = (TH1D*) in_cent[8]->Get("fwd_NP");
	h_fwd_cent_NP_pp[8] = (TH1D*) in_cent[8]->Get("fwd_NP");
	h_fwd_cent_NP_pb[8] = (TH1D*) in_cent[8]->Get("fwd_NP");
...
cout << "HERE" << endl;
	...
	drawText("Nonprompt J/#psi", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("Cent. 0-90%", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
	...
	//exit(1);
	drawText("NonPompt J/#psi", pos_x, pos_y, text_color, text_size*1.3);
	drawText("|y| < 1.6", pos_x, pos_y-pos_y_diff, text_color, text_size);
	drawText("Cent. 0-90%", pos_x, pos_y-pos_y_diff*2, text_color, text_size);
