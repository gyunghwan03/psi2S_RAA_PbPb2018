...
std::pair<string, string> get_histnames(bool get_pbpb, bool isPR, bool isFwd, float ptLow, float ptHigh, int cbinLow, int cbinHigh ){
	...
	if(get_pbpb) name_ref = Form("../../Eff_Acc/roots/TnP_Jpsi/mc_eff_PbPb_%s_pt%.1f_%.1f_y%.1f_%.1f_accYes_mass2.6_3.5_cent%d_%d_isTnP1_isPtWeight1_NOM.root", (isPR)? "PR" : "NP", ptLow, ptHigh, yl, yh, cbinLow, cbinHigh);
