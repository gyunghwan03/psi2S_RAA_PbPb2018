...
void syst_sigPAR()
{
    ...
    string syst_path_pp_alpha = "../pp_Jpsi/systematics/sigPAR/SigPar_alpha/roots/2DFit_No_Weight/Final/";
    string syst_path_pb_alpha = "../Jpsi/systematics/sigPAR/sigPAR_alpha/roots/2DFit_No_Weight/Final/";
    string syst_path_pp_n = "../pp_Jpsi/systematics/sigPAR/SigPar_n/roots/2DFit_No_Weight/Final/";
    string syst_path_pb_n = "../Jpsi/systematics/sigPAR/sigPAR_n/roots/2DFit_No_Weight/Final/";
    string syst_path_pp_f = "../pp_Jpsi/systematics/sigPAR/SigPar_f/roots/2DFit_No_Weight/Final/";
    string syst_path_pb_f = "../Jpsi/systematics/sigPAR/sigPAR_f/roots/2DFit_No_Weight/Final/";
    string syst_path_pp_x = "../pp_Jpsi/systematics/sigPAR/SigPar_x/roots/2DFit_No_Weight/Final/";
    string syst_path_pb_x = "../Jpsi/systematics/sigPAR/sigPAR_x/roots/2DFit_No_Weight/Final/";
