		...
		)
{
	...
	double paramsupper[8] = {1.5,  3.5  ,     3.,     3.,   1.0,     25.0};
	double paramslower[8] = {1e-6,  1.,   1e-6,   1e-06,   1e-6,      -25.0};
	...
	if(ptLow==6.5&&ptHigh==7.5&&yLow==0) { x_init = 1.3; }
	else if(ptLow==7.5&&ptHigh==8.5&&yLow==0) { x_init = 1.3; fit_limit = 3.28; }
	else if(ptLow==8.5&&ptHigh==9.5&&yLow==0) { x_init = 1.66; fit_limit = 3.26; }
	else if(ptLow==9.5&&ptHigh==11&&yLow==0) { x_init = 1.3; fit_limit = 3.28; }
	else if(ptLow==13&&ptHigh==15&&yLow==0) { x_init = 1.3; paramslower[1] = 1.; fit_limit = 3.28; }
	else if(ptLow==11&&ptHigh==13&&yLow==0) { x_init = 1.3; paramslower[1] = 1.; fit_limit = 3.28; }
	else if(ptLow==12&&ptHigh==15&&yLow==0) { x_init = 1.3; paramslower[1] = 1.; fit_limit = 3.28; }
	else if(ptLow==15&&ptHigh==17.5&&yLow==0) { x_init = 1.66; paramslower[1] = 1.; fit_limit = 3.28; }
	else if(ptLow==17.5&&ptHigh==20&&yLow==0) { x_init = 1.3; paramslower[1] = 1.; fit_limit = 3.28; }
	else if(ptLow==15&&ptHigh==20&&yLow==0) { x_init = 1.3; paramslower[1] = 1.; fit_limit = 3.28; }
	else if(ptLow==22.5&&ptHigh==25&&yLow==0) { x_init = 1.3; paramslower[1] = 1.; fit_limit = 3.28; }
	else if(ptLow==27.5&&ptHigh==30&&yLow==0) { x_init = 1.3; paramslower[1] = 1.; fit_limit = 3.28; }
	else if(ptLow==25&&ptHigh==40&&yLow==0) { x_init = 1.66; paramslower[1] = 1.; fit_limit = 3.28; paramsupper[3] = 5;}
	else if(ptLow==12&&ptHigh==15&&yLow==1.6) { x_init = 1.66; paramslower[1] = 1.; fit_limit = 3.32; }
	else if(ptLow==3.5&&ptHigh==4.5) {fit_limit = 3.3; x_init = 1.3;}
	else if(ptLow==3.&&ptHigh==4.5) {fit_limit = 3.3; x_init = 1.3;}
	else if(ptLow==3.&&ptHigh==4.) {fit_limit = 3.3; paramsupper[3] = 15; paramslower[1] = 1.;}
	else if(ptLow==4.&&ptHigh==5.) {fit_limit = 3.3; paramsupper[3] = 15; paramslower[1] = 1.;}
	else if(ptLow==5.&&ptHigh==6.5) {fit_limit = 3.3; paramsupper[3] = 15; paramslower[1] = 1e-6;}
	else if(ptLow==6.5&&ptHigh==9&&yLow==0) {fit_limit = 3.3; paramslower[1] = 1; x_init = 1.5; paramsupper[3] = 15.; }

	else if(ptLow==6.5&&ptHigh==40) {fit_limit = 3.3; paramslower[1] = 1.; x_init = 1.3;  paramslower[3] = 1.;}
	else if(ptLow==9&&ptHigh==40) {fit_limit = 3.26; paramslower[1] = 1.; x_init = 1.3;}
	else if(ptLow==3.5&&ptHigh==40) {fit_limit = 3.26; paramslower[1] = 1.; x_init = 1.3;}
	...
	TFile* outFile;
	outFile = new TFile(Form("roots_MC/pp_Mass/mc_MassFitResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d.root", kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP),"recreate");
	c_A->SaveAs(Form("figs/pp_mc_Mass/mc_Mass_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d.pdf", kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP));
