...
//  RooBinning bins(nBins, ctauErrLow, ctauErrHigh);
  ...
  else if(ptLow==20&&ptHigh==22.5) ctauErrMax=0.0563;
  else if(ptLow==22.5&&ptHigh==25) ctauErrMax=0.0563;
  else if(ptLow==25&&ptHigh==27.5) ctauErrMax=0.0499;
  else if(ptLow==27.5&&ptHigh==30.) ctauErrMax=0.0499;
  else if(ptLow==30&&ptHigh==40) ctauErrMax=0.0471;
  else if(ptLow==40&&ptHigh==50) ctauErrMax=0.03613;
  else if(ptLow==25&&ptHigh==50) ctauErrMax=0.0504;
  else if(ptLow==30&&ptHigh==50) ctauErrMax=0.0471;
  ...
  else if(ptLow==6.5&&ptHigh==50) ctauErrMax=0.2;
