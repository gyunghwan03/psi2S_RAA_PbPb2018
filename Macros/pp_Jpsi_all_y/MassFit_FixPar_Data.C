    ...
    )
{
  ...
  if(ptLow==6.5&&ptHigh==30) { paramslower[2] = 0.03; cout << "HERE" << endl; }
  ...
  else if(ptLow==6.5&&ptHigh==30) { NJpsi_limit = 1.0e+8; NBkg_limit = 1.0e+8; }
  else if(ptLow==20.&&ptHigh==22.) { NJpsi_limit = 2.0e+7; NBkg_limit = 2.0e+7; }
  else if(ptLow==30.&&ptHigh==40.) { NJpsi_limit = 2.0e+5; NBkg_limit = 2.0e+5; }
  else if(ptLow==40.&&ptHigh==50.) { NJpsi_limit = 2.0e+5; NBkg_limit = 2.0e+5; }
