...
commands_pTreweight = [
    ...
    "root -l -b -q mc_MassFit_HighpT.C'(9,   40, 0, 2,  0,   10, 1)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(9,   40, 0, 2,  10,  20, 1)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(9,   40, 0, 2,  20,  40, 1)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(9,   40, 0, 2,  40,  80, 1)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(9,   40, 0, 2, 80,  120, 1)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(9,   40, 0, 2, 120, 160, 1)'", 

    "root -l -b -q mc_MassFit_HighpT.C'(9,   40, 0, 2,  0,   10, 2)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(9,   40, 0, 2,  10,  20, 2)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(9,   40, 0, 2,  20,  40, 2)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(9,   40, 0, 2,  40,  80, 2)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(9,   40, 0, 2,  80, 120, 2)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(9,   40, 0, 2, 120, 160, 2)'", 
]
