    ...
    )
{
  ...
  RooRealVar   *f_CB2 = new RooRealVar("f_CB2","cb fraction", f_init);
  RooRealVar   kG("kG","Gauss / CB sigma ratio", kG_MC_value);
  RooRealVar   *fG = new RooRealVar("fG","Gaussian fraction in signal", fG_MC_value);
  ...
  RooGaussian* gauss = new RooGaussian("gauss","Gaussian PDF", *(ws->var("mass")), mean, sigmaG);
