...
commands_pTreweight = [
    "root -l -b -q mc_MassFit_HighpT.C'(6.5, 7.5, 0, 1.6)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(7.5, 8.5, 0, 1.6)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(8.5, 9.5, 0, 1.6)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(9.5,  11, 0, 1.6)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(11,   13, 0, 1.6)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(13,   15, 0, 1.6)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(15, 17.5, 0, 1.6)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(17.5, 20, 0, 1.6)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(20, 22.5, 0, 1.6)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(22.5, 25, 0, 1.6)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(25, 27.5, 0, 1.6)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(27.5, 30, 0, 1.6)'", 
    "root -l -b -q mc_MassFit_HighpT.C'(30,   40, 0, 1.6)'", 

    "root -l -b -q mc_MassFit_HighpT.C'(3.5, 4.5, 1.6, 2.4)'",
    "root -l -b -q mc_MassFit_HighpT.C'(4.5, 6.5, 1.6, 2.4)'",
    "root -l -b -q mc_MassFit_HighpT.C'(6.5, 8.5, 1.6, 2.4)'",
    "root -l -b -q mc_MassFit_HighpT.C'(8.5,  12, 1.6, 2.4)'",
    "root -l -b -q mc_MassFit_HighpT.C'(12,   15, 1.6, 2.4)'",
    "root -l -b -q mc_MassFit_HighpT.C'(15,   20, 1.6, 2.4)'",
    "root -l -b -q mc_MassFit_HighpT.C'(20,   40, 1.6, 2.4)'",
...
def _parse_bin_label(cmd: str) -> str:
    ...
    출력 라벨:
      "MassFit_FixPar_Data.C | pT[6.5,9], y[0,1.6], cent[0,180], isPR=1"
    """
    try:
        ...
        if len(parts) >= 7:
            ...
            # cat을 isPR 표기(PR/NP)로 매핑
            cat_str = str(cat).strip()
            try:
                cat_val = int(float(cat_str))  # "1", "1.0" 모두 수용
            except ValueError:
                cat_val = None
            ispr = "PR" if cat_val == 1 else ("NP" if cat_val == 2 else cat_str)
            return f"{macro} | pT[{pt1},{pt2}], y[{y1},{y2}], cent[{c1},{c2}], isPR={ispr}"
        # 예외 시 원문 반환
        return tail
    except Exception:
        return cmd
