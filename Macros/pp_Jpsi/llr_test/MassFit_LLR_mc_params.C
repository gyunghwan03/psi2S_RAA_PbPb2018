		...
		)
{
	...
	f1 = new TFile("../../../skimmedFiles/OniaRooDataSet_isMC0_JPsi_pp_y0.00_2.40_Effw0_Accw0_PtW1_TnP1_230209.root");
	...
	RooRealVar   *x_A = new RooRealVar("x_A","sigma ratio ", x_init, 1e-6, 1.);
	...
	RooRealVar    alpha_1_A("alpha_1_A","tail shift", alpha_1_init, 1e-6, 2.3);
	RooFormulaVar alpha_2_A("alpha_2_A","1.0*@0",RooArgList(alpha_1_A) );
	//RooRealVar    n_1_A("n_1_A","power order", n_1_init);
	RooRealVar    n_1_A("n_1_A","power order", n_1_init, 1e-6, 1e+6);
	...
	RooRealVar *N_Jpsi= new RooRealVar("N_Jpsi","inclusive Jpsi signals", 0, 5e6);
	RooRealVar *N_Bkg = new RooRealVar("N_Bkg","fraction of component 1 in bkg", 0, 2e6);
	...
	myPlot2_A->GetXaxis()->SetRangeUser(massLow,3.5);
