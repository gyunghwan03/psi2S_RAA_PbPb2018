		...
		)
{
	...
	else if(ptLow==7.5&&ptHigh==8.5&&yLow==0) { x_init = 1.3; }
	...
	else if(ptLow==15&&ptHigh==17.5&&yLow==0) { x_init = 1.3; paramslower[1] = 1.; fit_limit = 3.28; }
	...
	else if(ptLow==30&&ptHigh==40&&yLow==0) { x_init = 1.3; paramslower[1] = 1.; fit_limit = 3.28; paramsupper[3] = 5;}
	else if(ptLow==12&&ptHigh==15&&yLow==1.6) { x_init = 1.66; paramslower[1] = 1.; fit_limit = 3.32; }
	else if(ptLow==3.5&&ptHigh==4.5) {fit_limit = 3.3; }
