		...
		)
{
    ...
    gSystem->mkdir(Form("figs/mc_pp_Mass"),kTRUE);
	...
	sigma_up=0.12; x_up=3.5; alpha_up=10; n_up=10; f_up=1;
	sigma_lo=1e-3; x_lo=1.; alpha_lo=1e-3; n_lo=1e-3; f_lo=1e-3;
    ...
    if(ptLow==3.5&&ptHigh==4.5) {
        N_Jpsi_high = 4500000; // 2500000
        f_init=0.5; sigma_1_init = 0.05; n_1_init = 2;
        x_init = 1.5; alpha_1_init = 2.3;
        fit_limit_high = 3.9; 
    }
    ...
    if(ptLow==7.5&&ptHigh==8.5) {
        N_Jpsi_high = 250000; // 2500000
        x_lo = 1.3;
        x_init = 2.66;
        fit_limit_high = 3.91;
    }
    ...
    */
    ...
    c_A->SaveAs(Form("figs/mc_pp_Mass/mc_Mass_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d.pdf",  kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP));
