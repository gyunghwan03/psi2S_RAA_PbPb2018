...
//  RooBinning bins(nBins, ctauErrLow, ctauErrHigh);
  ...
  if(ptLow==3.5&&cLow==0&&cHigh==20) ctauErrMax = 0.1548;
  //if(ptLow==3&&ptHigh==6.5) ctauErrMax=0.1476;
  //else if(ptLow==6.5&&ptHigh==9&&yLow==0) { ctauErrMax=0.1348; cout << "NOT HERE" << endl; }
  //else if(ptLow==6.5&&ptHigh==9&&yLow==1.6) { ctauErrMax=0.1332; cout << "HERE" << endl; }
  //else if(ptLow==6.5&&ptHigh==40&&cLow==40&&cHigh==60) ctauErrMax=0.1134;
  //else if(ptLow==6.5&&ptHigh==40&&cLow==60&&cHigh==80) ctauErrMax=0.1116;
  //else if(ptLow==3.5&&cLow==20&&cHigh==60) ctauErrMax=0.1673;
