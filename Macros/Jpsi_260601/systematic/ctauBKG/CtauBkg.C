    ...
    )
{
  ...
  else if(ptLow==3.5&&ptHigh==40&&cLow==0&&cHigh==20){
  ws->factory("b_Bkg[0.5, 0., 1.]");//NP fraction for bkg
  ...
  ws->factory("lambdaDSS_Bkg2[0.2, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg3[0.6, 1e-6, 1.]");
  ws->factory("fDSS12[0.7, 1e-6, 1.]");
  ws->factory("fDF12[0.5, 1e-6, 1.]");
  ws->factory("fDSS13[0.6, 1e-6, 1.]");
  ws->factory("fDF13[0.9, 1e-6, 1.]");}
  ...
  ws->factory("fDSS13[0.6, 1e-6, 1.]");
  ws->factory("fDF13[0.9, 1e-6, 1.]");}
  else if(ptLow==12&&ptHigh==40&&yLow==1.6){
  ws->factory("b_Bkg[0.5, 0., 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.8, 1e-6, 1.]");
  ws->factory("fDLIV[0.6, 1e-6, 1]");
  ws->factory("lambdaDDS_Bkg[0.2, 1e-6, 1.]");
  ...
  ws->factory("lambdaDF_Bkg3[0.1, 1e-6, 1]");
  ws->factory("lambdaDSS_Bkg1[0.4, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg2[0.29, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg3[0.43, 1e-6, 1.]");
  ws->factory("fDSS12[0.7, 1e-6, 1.]");
  ws->factory("fDF12[0.5, 1e-6, 1.]");
  ws->factory("fDSS13[0.6, 1e-6, 1.]");
  ws->factory("fDF13[0.9, 1e-6, 1.]");}
  ...
  else if(ptLow==3.5&&cLow==0&&cHigh==20) { ctauMin = -2.5; }
  else if(ptLow==3.5&&cLow==60&&cHigh==80) { ctauMin = -2.; }
  else if(ptLow==3.5&&ptHigh==6.5) ctauMin = -2.2;
  else if(ptLow==12&&ptHigh==40) { ctauMin = -2.; ctauMax = 2.; }
