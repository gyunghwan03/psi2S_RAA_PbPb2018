    ...
    )
{
  ...
  if (ptLow==25&&ptHigh==40) {nGauss=2;}
  ...
  else if(ptLow==3&&ptHigh==4){
  ws->factory("s1_CtauRes[0.7, 1e-6, 1.0]");
  ws->factory("rS21_CtauRes[1.1, 1., 3.0]");
  ws->factory("rS32_CtauRes[2.3, 1., 5.0]");
  ws->factory("f_CtauRes[0.1, 1e-6, 1.]");
  ws->factory("f2_CtauRes[0.1, 1e-6, 1.]"); }
  else if(ptLow==4&&ptHigh==5){
  ws->factory("s1_CtauRes[0.7, 1e-6, 1.0]");
  ws->factory("rS21_CtauRes[1.1, 1., 3.0]");
  ws->factory("rS32_CtauRes[2.3, 1., 5.0]");
  ws->factory("f_CtauRes[0.1, 1e-6, 1.]");
  ...
  if(ptLow==3.5&&ptHigh==6.5) ctauResMin = -7.4;
  else if(ptLow==6.5&&ptHigh==9&&yLow==1.6) ctauResMin = -7.4;
  else if(ptLow==9&&ptHigh==12&&yLow==1.6) ctauResMin = -20;
  else if(ptLow==12&&ptHigh==40) ctauResMin=-20;
  else if(ptLow==25&&ptHigh==40) ctauResMin=-6;
