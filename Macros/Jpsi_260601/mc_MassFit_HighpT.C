		...
		)
{
	...
	double sigma_high = 0.16;
	double x_low = 1.;
	double x_high = 3.5;
	double alpha_low = 1.1;
	double alpha_high = 4.;
	double n_low = 0.2;
	double n_high = 3.;
	double f_low = 1e-6;
	...
	////sigma_1_init = 0.041;
	//}
	//else if(ptLow==4&&ptHigh==5&&yLow==1.6) {
	//N_Jpsi_high = 5e+7;
	//}
	//else if(ptLow==6&&ptHigh==7&&yLow==1.6) {
	//N_Jpsi_high = 5e+7;
	//}
	...
	//alpha_1_init = 2.5;
	//}
	//else if(ptLow==3.5&&ptHigh==40&&cLow==20&&cHigh==60)
	//{
	//N_Jpsi_high = 1e+8;
	//n_1_init = 3.5;
	//f_init = 0.4;
	...
	//alpha_1_init = 2.5;
	//}
	//else if(ptLow==3.5&&ptHigh==40&&cLow==60&&cHigh==100)
	//{
	//N_Jpsi_high = 1e+8;
	//n_1_init = 3.5;
	//f_init = 0.4;
	...
	//alpha_1_init = 2.5;
	//}
	if(ptLow==6.5&&ptHigh==7.5&&yLow==0) { x_init = 1.2; } 
	else if(ptLow==7.5&&ptHigh==8.5&&yLow==0) { x_init = 1.2; } 
	else if(ptLow==9.5&&ptHigh==11&&yLow==0) { x_init = 1.2; } 
	else if(ptLow==11&&ptHigh==13&&yLow==0) { x_init = 1.2; } 
	else if(ptLow==27.5&&ptHigh==30&&yLow==0) { x_init = 1.31; } 
	else if(ptLow==15&&ptHigh==20&&yLow==1.6) { x_init = 1.31; } 
	else if(ptLow==20&&ptHigh==40&&yLow==1.6) { x_init = 1.31; } 
