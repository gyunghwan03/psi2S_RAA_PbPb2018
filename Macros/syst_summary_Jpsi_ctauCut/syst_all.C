                                     ...
                                     bool save_subcomponents = false)
{
    ...
    const string nominal_path_pp = "../Jpsi_L_cut/roots_1S_pp/";
    const string nominal_path_pb = "../Jpsi_L_cut/roots_1S_Pb/";
    const string syst_base_pp    = "../Jpsi_L_cut/systematic_pp/";
    const string syst_base_pb    = "../Jpsi_L_cut/systematic_Pb/";
