    ...
    )
{
  ...
  ws->factory("lambdaDSS4[0.3601, 1e-6, 1.0]");
  ...
  drawText(Form("#lambdaDSS4 = %.4f #pm %.4f", ws->var("lambdaDSS4")->getVal(), ws->var("lambdaDSS4")->getError() ),text_x+0.5,text_y-y_diff*3,text_color,text_size);
