    ...
    )
{
  ...
  ws->factory("lambdaDSS_Bkg1[0.26, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg2[0.36, 1e-6, 1.]");
  ws->factory("fDSS12[0.3, 1e-6, 1.]");
  ws->factory("fDF12[0.5, 1e-6, 1.]");}
  ...
  ws->factory("fDLIV[0.5, 1e-6, 1]");
  ws->factory("lambdaDDS_Bkg[0.02, 1e-6, 1.]");
  ws->factory("lambdaDF_Bkg1[0.05, 1e-6, 1]");
  ws->factory("lambdaDF_Bkg2[0.05, 1e-6, 1]");
  ws->factory("lambdaDSS_Bkg1[0.26, 1e-6, 1.]");
  ws->factory("lambdaDSS_Bkg2[0.36, 1e-6, 1.]");
  ws->factory("fDSS12[0.3, 1e-6, 1.]");
  ...
  if(ptLow==6.5&&cLow==60&&cHigh==80) {ctauMin=-1.5; ctauMax=2.3;}
  else if(ptLow==20&&ptHigh==25) ctauMax=2.3;
  else if(ptLow==25&&ptHigh==40) ctauMax=2.;
  else if(ptLow>=15) ctauMin = -2;
  else if(ptLow==3.5&&cLow==20&&cHigh==60) ctauMin=-2.5;
