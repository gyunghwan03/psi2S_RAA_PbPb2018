...
#do
#    root -l -b -q 'CtauErr.C(6.5,40,0,1.6,'$cent')'
#done
#for cent in '0,20' '20,60' '60,100' '100,180'
for cent in '20,40' '40,60' 
do
    root -l -b -q 'CtauErr.C(3.5,40,1.6,2.4,'$cent')'
done
...
#for cent in '0,20' '20,40' '40,60' '60,80' '80,100' '100,180'
#do
#    root -l -b -q 'CtauErr.C(6.5,40,0,2.4,'$cent')'
#done
#for cent in '0,40' '40,80' '80,180'
#do
#    root -l -b -q 'CtauErr.C(3,40,1.6,2.4,'$cent')'
#done
