...
//  ctauErrMax = 0.06;}//0.124872
  ...
  else if(ptLow==6.5 && ptHigh==40 && cLow==100) ws->factory("b_Jpsi[0.372, 0.36, 0.38]");//NP fraction for Sig
  else if(ptLow==6.5&&ptHigh==9&&yLow==0) ws->factory("b_Jpsi[0.289, 0.28, 0.32]");
  if(ptLow==6.5 && ptHigh==40 && cLow==0 && cHigh==180) ws->factory("b_Jpsi[0.38, 0.36, 0.4]");//NP fraction for Sig
