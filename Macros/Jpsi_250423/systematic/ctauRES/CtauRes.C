    ...
    )
{
  ...
  //fMC = new TFile(Form("../../../../skimmedFiles/OniaRooDataSet_miniAOD_isMC1_Psi2S_Prompt_cent0_200_Effw0_Accw0_PtW0_TnP0_230601.root"));
  fMC = new TFile(Form("../../../../skimmedFiles/OniaRooDataSet_miniAOD_isMC1_JPsi_Prompt_cent0_200_Effw0_Accw0_PtW0_TnP0_240530.root"));

  RooAddPdf* pdfMASS_Tot = (RooAddPdf*)fMass->Get("pdfMASS_Tot");
  //RooDataSet *dataw_Sig = (RooDataSet*)fCErr->Get("dataw_Sig");

  RooDataSet* dataset = (RooDataSet*)fMC->Get("dataset");
  ...
  cout << "ctauResMin = " << ws->var("ctau3DRes")->getMin() << ", ctauResMax = " << ws->var("ctau3DRes")->getMax() << endl;
  ...
  RooDataSet *ctauResCutDS =(RooDataSet*)dsAB->reduce(RooArgSet(*(ws->var("ctau3DRes")),*(ws->var("ctau3D")),*(ws->var("ctau3DErr"))),Form("ctau3DRes<10&&ctau3DErr>%f&&ctau3DErr<%f",ctauErrMin,ctauErrMax));
  ...
  int nGauss = 3;
  if(ptLow==3.5&&cLow==0&&cHigh==20) nGauss=2;
  if(ptLow==3.5&&ptHigh==6.5) nGauss=3;
  if(ptLow==6.5&&ptHigh==9&&yLow==1.6) nGauss=2;
  if(ptLow==3.5&&cLow==20&&cHigh==60) nGauss=2;
  if(ptLow==3.5&&cLow==60&&cHigh==100) nGauss=2;
  if(ptLow==3.5&&ptHigh==40&cLow==0&&cHigh==180) nGauss=2;
  ...
  ws->factory("s1_CtauRes[0.5, 1e-3, 1.]");
  ws->factory("rS21_CtauRes[1.18, 1e-3, 10.]");
  ...
  ws->factory("ctau4_CtauRes[0.]");  //ws->factory("s4_CtauRes[5.37, 0., 10.]");
  ws->factory("s1_CtauRes[0.8, 1e-3, 1.0]");
  ws->factory("rS21_CtauRes[1.6, 1., 3.0]");
  ws->factory("rS32_CtauRes[3.1, 1., 5.0]");}
  ...
  ws->factory("ctau4_CtauRes[0.]");  //ws->factory("s4_CtauRes[5.37, 0., 10.]");
  ws->factory("s1_CtauRes[0.8, 1e-3, 1.0]");
  ws->factory("rS21_CtauRes[1.6, 1.3, 5.0]");
  ws->factory("rS32_CtauRes[3.1, 2., 5.0]");}
  ...
  ws->factory("ctau4_CtauRes[0.]");  //ws->factory("s4_CtauRes[5.37, 0., 10.]");
  ws->factory("s1_CtauRes[0.8, 1e-3, 1.0]");
  ws->factory("rS21_CtauRes[2.7, 1e-3, 3.0]");
  ws->factory("rS32_CtauRes[3.57, 1e-3, 5.0]");}
  ...
  ws->factory("ctau4_CtauRes[0.]");  //ws->factory("s4_CtauRes[5.37, 0., 10.]");
  ws->factory("s1_CtauRes[0.8, 1e-3, 1.0]");
  ws->factory("rS21_CtauRes[1.7, 1e-3, 3.0]");
  ws->factory("rS32_CtauRes[3.57, 2., 5.0]");}
  ...
  ws->factory("s1_CtauRes[0.8, 1e-3, 1.0]");
  ws->factory("rS21_CtauRes[1.6, 1., 5.0]");
  ws->factory("rS32_CtauRes[3.0, 2., 5.0]");}
  ...
  ws->factory("s1_CtauRes[0.8, 1e-3, 1.0]");
  ws->factory("rS21_CtauRes[1.6, 1e-3, 5.0]");
  ws->factory("rS32_CtauRes[3.0, 1.5, 5.0]");}
  ...
  ws->factory("ctau4_CtauRes[0.]");  //ws->factory("s4_CtauRes[5.37, 0., 10.]");
  ws->factory("s1_CtauRes[0.8, 1e-3, 1.0]");
  ws->factory("rS21_CtauRes[1.6, 1., 2.0]");
  ws->factory("rS32_CtauRes[3.0, 1., 5.0]");}
  else if(ptLow>=15){
  ws->factory("ctau1_CtauRes[0.]");  
  ws->factory("ctau2_CtauRes[0.]");  //ws->factory("s2_CtauRes[2., 1e-6, 10.]");
  ...
  ws->factory("s1_CtauRes[0.8, 1e-3, 1.0]");
  ws->factory("rS21_CtauRes[1.6, 1e-3, 5.0]");
  ws->factory("rS32_CtauRes[3.0, 1e-3, 5.0]");}
  ...
  if(cLow==00&&cHigh==60) {ws->factory("f_CtauRes[0.5, 0.1, 1.]");ws->factory("f2_CtauRes[0.3, 1e-6, 1.]");ws->factory("f3_CtauRes[0.5, 1e-6, 1.]");}
  ...
  else if(ptLow==3.5&&cLow==0&&cHigh==20) {ws->factory("f_CtauRes[0.42, 1e-3, 1.]");ws->factory("f2_CtauRes[0.2, 1e-3, 1.]");ws->factory("f3_CtauRes[0.5, 1e-6, 1.]");}
  ...
  TH1D* hTot = (TH1D*)ws->data("ctauResCutDS")->createHistogram(("hTot"), *ws->var("ctau3DRes"),Binning(nCtauResBins,ctauResLow,ctauResHigh));
  double ctauResMin=-10;
  double ctauResMax=10;
  ...
  for(int i=hTot->GetNbinsX()/2; i<hTot->GetNbinsX(); i++){
    ...
    if(hTot->GetBinContent(i)<=0&&hTot->GetBinContent(i+1)<=0){
      ...
      ctauResMax = hTot->GetBinLowEdge(i);
	  break;
    }
  ...
  if(ptLow==3.5&&cLow==0&&cHigh==20) { ctauResMin=-25; ctauResMax=25; }
  if(ptLow==3.5&&cLow==20&&cHigh==40) { ctauResMin=-25; ctauResMax=25; }
  else if(ptLow==3.5&&ptHigh==40&&cLow==0&&cHigh==180) { ctauResMin=-15; ctauResMax=15;}
  else if(ptLow==3.5&&ptHigh==6.5) { ctauResMin=-13; ctauResMax=13; }
  else if(ptLow==6.5&&ptHigh==9&&yLow==1.6) { ctauResMin=-15; ctauResMax=15; }
  ...
  RooDataSet* dataToFit = (RooDataSet*)ctauResCutDS->reduce(Form("ctau3DRes>=%.f&&ctau3DRes<=%.f",ctauResMin,ctauResMax))->Clone("ctauResCutDS");
  ...
  pullFrame_C->GetXaxis()->SetTitleSize(0.11) ;
