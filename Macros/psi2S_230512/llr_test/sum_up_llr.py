...
fwd_pt = [(3.5, 6.5), (6.5, 9.0), (9.0, 12.0), (12.0, 50.0), ]
mid_pt = [(6.5, 9.0), (9.0, 12.0), (12.0, 15.0), (15.0, 20.0), (20.0, 25.0), (25.0, 50.0)]
rapidity = [(0, 1.6), (1.6, 2.4)]
cent_list = [(0, 20), (20, 40), (40, 60), (60, 80), (80, 100), (100, 180)]
...
for pt_low, pt_high in fwd_pt:
    ...
    for bkg_name in bkg_names:
        in_file_name = f'Mass_Inclusive_pt{pt_low}-{pt_high}_y1.6-2.4_muPt0.0_centrality{cent_low}-{cent_high}_{bkg_name}.txt'
    ...
    out_path = f'tables/llr_table_pt{pt_low}_{pt_high}_y1.6_2.4_cent{cent_low}_{cent_high}.txt'
    with open(out_path, 'w') as out_file:
        out_file.write('\\begin{table}[h]\n')
        out_file.write('\\caption{$p_T=' + f'{pt_low}-{pt_high}' +'$ GeV, $y=1.6-2.4 $, Cent.=0-90 \\%}\n')
...
for pt_low, pt_high in mid_pt:
    ...
    # Fill the nll values
    for bkg_name in bkg_names:
        in_file_name = f'Mass_Inclusive_pt{pt_low}-{pt_high}_y0.0-1.6_muPt0.0_centrality{cent_low}-{cent_high}_{bkg_name}.txt'
        input_path = in_dir_path + '/' + in_file_name
    ...
    # Make a table and save to txt file
    out_path = f'tables/llr_table_pt{pt_low}_{pt_high}_y0.0_1.6_cent{cent_low}_{cent_high}.txt'
    with open(out_path, 'w') as out_file:
        out_file.write('\\begin{table}[h]\n')
        out_file.write('\\caption{$p_T=' + f'{pt_low}-{pt_high}' +'$ GeV, $y=0.0-1.6 $, Cent.=0-90 \\%}\n')
        out_file.write('\\centering\n')
        out_file.write('\\begin{tabular}{c|c|c|c|c|c|c|c}\n')
        out_file.write('\\hline\n')
        out_file.write(' N & NLL & p(H0: &  p(H0:   &  p(H0:  &   p(H0: & p(H0: & p(H0: \\\\ \n')
...
# Forward Cent. (pT 3.5 - 50.0)
for cent_low, cent_high in cent_list:
    pt_low = 3.5
    pt_high = 50.0
    nlls = {}
    # Fill the nll values
    ...
    with open(out_path, 'w') as out_file:
        out_file.write('\\begin{table}[h]\n')
        out_file.write('\\caption{$p_T=' + f'{pt_low}-{pt_high}' +'$ GeV, $y=1.6-2.4 $, Cent.=' + f'{cent_low}-{cent_high}' + '\\%}\n')
        out_file.write('\\centering\n')
        out_file.write('\\begin{tabular}{c|c|c|c|c|c|c|c}\n')
        out_file.write('\\hline\n')
        out_file.write(' N & NLL & p(H0: & p(H0: & p(H0: & p(H0: & p(H0: & p(H0: \\\\ \n')
...
for cent_low, cent_high in cent_list:
    ...
    with open(out_path, 'w') as out_file:
        out_file.write('\\begin{table}[h]\n')
        out_file.write('\\caption{$p_T=' + f'{pt_low}-{pt_high}' +'$ GeV, $y=0.0-1.6 $, Cent.=' + f'{cent_low}-{cent_high}' + '\\%}\n')
        out_file.write('\\centering\n')
        out_file.write('\\begin{tabular}{c|c|c|c|c|c|c|c}\n')
        out_file.write('\\hline\n')
        out_file.write(' N & NLL & p(H0: &  p(H0:   &  p(H0:  &   p(H0: & p(H0: & p(H0: \\\\ \n')
