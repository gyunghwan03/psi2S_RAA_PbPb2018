...
void compare_pT_PR(bool isSys=false)
{
  ...
  double binWidth_alice[4] = {1,1,1,6};
  ...
  double alice_var[4]={0.4,0.35,0.22,0.14};
  double alice_err[4]={0.1,0.07,0.07,0.05};
  ...
  TGraphErrors *g_alice = new TGraphErrors(4,x_alice,alice_var,0,alice_err);
