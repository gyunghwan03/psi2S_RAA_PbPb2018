...
void draw_Raa_JPsi_y1p6_2p4_Cent_4Bins(bool isSys=true)
{
	...
	TFile *fEff_PbPbPR = new TFile("../../../Eff_Acc_260203/roots/mc_eff_vs_pt_cent_0_to_180_rap_prompt_pbpb_JPsi_PtWnomi_tnp1_ctauCut_260310.root");
	TFile *fEff_PbPbNP = new TFile("../../../Eff_Acc_260203/roots/mc_eff_vs_pt_cent_0_to_180_rap_nprompt_pbpb_JPsi_PtWnomi_tnp1_ctauCut_260310.root");
    TFile *fEff_ppPR = new TFile("../../../Eff_Acc_260203/roots/mc_eff_vs_pt_rap_prompt_pp_Jpsi_PtWnomi_tnp1_ctauCut_260310.root");
    TFile *fEff_ppNP = new TFile("../../../Eff_Acc_260203/roots/mc_eff_vs_pt_rap_nprompt_pp_Jpsi_PtWnomi_tnp1_ctauCut_260310.root");
    ...
    for(int i=0;i<nCentBins;i++)
    {
        ...
        cfrac[i] = (centBin[i+1]-centBin[i])/100.;
		cout.precision(9);
		//cout << " " << endl;
