...
void draw_Raa_JPsi_y0_1p6_Cent(bool isSys=false)
{
    ...
    TH1D *hEff_ppPR = JPsiEffAcc260429::BuildIntegratedRatioHist(fEff_ppPR, "hist_eff_num_mid", "hist_eff_den_mid", "hEff_ppPR_mid_260429");
    TH1D *hEff_ppNP = JPsiEffAcc260429::BuildIntegratedRatioHist(fEff_ppNP, "hist_eff_num_mid", "hist_eff_den_mid", "hEff_ppNP_mid_260429");
