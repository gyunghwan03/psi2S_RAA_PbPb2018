...
void draw_Raa_psi2S_y1p6_2p4_Cent_241223(bool isSys=true, double ptHigh = 40)
{
	...
	TFile *fEff_PbPbPR = new TFile("../../Eff_Acc/roots/mc_eff_vs_pt_cent_0_to_180_rap_prompt_pbpb_psi2s_PtW1_tnp1_20241223_ppWfunc.root");
    TFile *fEff_PbPbNP = new TFile("../../Eff_Acc/roots/mc_eff_vs_pt_cent_0_to_180_rap_prompt_pbpb_psi2s_PtW1_tnp1_20241223_ppWfunc.root");
    //TFile *fEff_PbPbNP = new TFile("../../Eff_Acc/roots/mc_eff_vs_pt_cent_0_to_180_rap_nprompt_pbpb_psi2s_PtW1_tnp1_20241223_ppWfunc.root");
    ...
    TH1D *hEff_PbPbPR = (TH1D*) fEff_PbPbPR -> Get("mc_eff_vs_cent_TnP1_PtW1_pt_3p5_to_40_absy1p6_2p4_2");
    TH1D *hEff_PbPbNP = (TH1D*) fEff_PbPbNP -> Get("mc_eff_vs_cent_TnP1_PtW1_pt_3p5_to_40_absy1p6_2p4_2");
...
*/
	...
	cXPR->SaveAs(Form("figs/CrossSection_PR_y1p6_2p4_Cent_pt3p5_%.f_241223.pdf",ptHigh));
	...
	cXNP->SaveAs(Form("figs/CrossSection_NP_y1p6_2p4_Cent_pt3p5_%.f_241223.pdf",ptHigh));
	...
	cRAA->SaveAs(Form("figs/RAA_psi2S_y1p6_2p4_Cent_Sys%d_pt3p5_%.f_241223.pdf",isSys,ptHigh));

	TFile *f1 = new TFile(Form("roots/RAA_psi2S_forRap_Npart_pt3p5_%.f_241223.root",ptHigh),"recreate");
	f1->cd();
	hRAA_PR->Write();
	hRAA_NP->Write();
	f1->Close();
...
valErr getYield_PbPb(int i, double ptHigh){
    double centBin[6] = {0,20,40,60,100,180};
    TString kineLabel[6];
