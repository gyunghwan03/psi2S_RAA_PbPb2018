...
void DoubleRatio_Charmonia_Npart_midRap_240807()
{
	...
	leg1->AddEntry(g_midPR,"#bf{Prompt}, 6.5 < p_{T} < 40 GeV/c, |y| < 1.6,  Cent. 0-90%");
	...
	c1->SaveAs("figs/DoubleRatio_Prompt_Npart_240807.pdf");
	c1->SaveAs("figs/DoubleRatio_Prompt_Npart_240807.png");
}
