...
void draw_Raa_JPsi_y0_1p6_Cent_8Bins(bool isSys=true)
{
...
*/
	...
	cRAA->SaveAs(Form("./figs/RAA_JPsi_y0_1p6_Npart_Sys%d_8Bins.pdf",isSys));

	TFile *outFile = new TFile("./roots/RAA_JPsi_midRap_Npart_8Bins.root","recreate");
	hRAA_PR->Write();
	hRAA_NP->Write();
