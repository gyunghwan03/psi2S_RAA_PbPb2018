...
void compare_pT_Jpsi_260519v2(bool isSys = false)
{
	gStyle->SetOptStat(0);
	setTDRStyle();
	...
	c1->SaveAs(Form("./figs/compare_mid_pT_Jpsi_PR_260519v2_Sys%d.pdf",isSys));
	...
	c2->SaveAs(Form("./figs/compare_fwd_pT_Jpsi_PR_260519v2_Sys%d.pdf",isSys));
	...
	c3->SaveAs(Form("./figs/compare_mid_pT_Jpsi_NP_260519v2_Sys%d.pdf",isSys));
	...
	c4->SaveAs(Form("./figs/compare_fwd_pT_Jpsi_NP_260519v2_Sys%d.pdf",isSys));
}
