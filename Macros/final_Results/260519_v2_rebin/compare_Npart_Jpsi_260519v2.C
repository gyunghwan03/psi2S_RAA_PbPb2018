...
void compare_Npart_Jpsi_260519v2(bool isSys=false)
{
	gStyle->SetOptStat(0);
	setTDRStyle();
	...
	c1->SaveAs(Form("./figs/compare_PR_mid_Npart_Jpsi_260519v2.pdf"));
	...
	c2->SaveAs(Form("./figs/compare_PR_fwd_Npart_Jpsi_260519v2.pdf"));
	...
	c3->SaveAs(Form("./figs/compare_NP_mid_Npart_Jpsi_260519v2.pdf"));
	...
	c4->SaveAs(Form("./figs/compare_NP_fwd_Npart_Jpsi_260519v2.pdf"));
}
