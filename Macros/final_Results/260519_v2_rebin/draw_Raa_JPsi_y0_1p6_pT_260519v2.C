...
void draw_Raa_JPsi_y0_1p6_pT_260519v2(bool isSys = false)
{
	//gROOT->SumW2();
	gStyle->SetOptStat(0);
	setTDRStyle();
	...
	cXPR->SaveAs("./figs/CrossSection_JPsi_260519v2_PR_y0_1p6_pT.pdf");
	...
	cXNP->SaveAs("./figs/CrossSection_JPsi_260519v2_NP_y0_1p6_pT.pdf");
	...
	cRAA->SaveAs(Form("./figs/RAA_JPsi_y0_1p6_pT_260519v2_Sys%d.pdf",isSys));

	TFile *f1 = new TFile("./roots/RAA_JPsi_midRap_pT.root","recreate");
	f1->cd();
	hRAA_PR->Write();
	hRAA_NP->Write();
	f1->Close();
...
valErr getYield_pp(int i){
	double ptBins[7] = {6.5,9,12,15,20,25,40};
	TString kineLabel[7];
...
valErr getFrac_PbPb(int i) {
	double ptBin[7] = {6.5,9,12,15,20,25,40};
	TString kineLabel[7];
