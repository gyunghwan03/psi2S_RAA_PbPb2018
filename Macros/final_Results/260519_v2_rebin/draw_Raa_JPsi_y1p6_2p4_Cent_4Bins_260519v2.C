...
void draw_Raa_JPsi_y1p6_2p4_Cent_4Bins_260519v2(bool isSys=true)
{
    ...
    TH1D *hEff_ppPR = JPsiEffAcc260519v2::BuildIntegratedRatioHist(fEff_ppPR, "hist_eff_num_fwd", "hist_eff_den_fwd", "hEff_ppPR_fwd_260519v2");
    TH1D *hEff_ppNP = JPsiEffAcc260519v2::BuildIntegratedRatioHist(fEff_ppNP, "hist_eff_num_fwd", "hist_eff_den_fwd", "hEff_ppNP_fwd_260519v2");
    ...
    for(int i=0;i<nCentBins;i++)
    {
        ...
        cout << "PbPb Yield	: "<< yieldPbPb.val << ",	Yield Err	: "  << yieldPbPb.err << ",	Eff PR	: " << eff_PbPbPR << ",	Eff NP	: " << eff_PbPbNP << ",	Acc PR	: " << acc_PbPbPR << ",	Acc NP  :   " << acc_PbPbNP << ",	b frac	: " << fracPbPb.val << ",	b frac Err	: " << fracPbPb.err << endl;
        cout << "pp Yield	: " << yieldPP.val << ",	Yield Err	: " << yieldPP.err <<  ",	Eff PR	: " << eff_ppPR << ",	Eff NP	: " << eff_ppNP << ",	Acc PR	: " << acc_ppPR << ",	Acc NP  :   " << acc_ppNP << ",	b frac	: " << fracPP.val << ",	b frac Err	: " << fracPP.err << endl;
		cout << "PbPb PR Yield  : " << yieldPbPb.val*(1-fracPbPb.val) << ", Err :   " << err_PbPbPR << " ,	weight : " << weight_PbPbPR <<  ",	Err wgt :	" << err_PbPbPR_wgt << ", PbPb NP Yield   : " << yieldPbPb.val*fracPbPb.val << "    Err :   " << err_PbPbNP << endl;
        ...
        */
        ...
        Xpp_PR[i] = lumi_pp_scale*yieldPP_PR/(lumi_pp*1e+2*(double)(40.-3.5)*(double)2*(2.4-1.6));
        Xpp_PR_err[i] = Xpp_PR[i]*sqrt(TMath::Power(err_PPPR_wgt/yieldPP_PR,2) + TMath::Power(lumi_pp_err/(lumi_pp*1e+2),2));
        Xpp_NP[i] = lumi_pp_scale*yieldPP_NP/(lumi_pp*1e+2*(double)(40.-3.5)*(double)2*(2.4-1.6));
...
*/
	...
	cXPR->SaveAs("figs/CrossSection_JPsi_PR_y1p6_2p4_Cent_260519v2.pdf");
	...
	cXNP->SaveAs("figs/CrossSection_JPsi_NP_y1p6_2p4_Cent_260519v2.pdf");
	...
	pad1_2->cd();
	double fwdPR2S_int  = 0.427; double fwdPR2S_intErr = 0.0021;
	double fwdNP2S_int  = 0.424; double fwdNP2S_intErr = 0.0029;
	...
	cRAA->SaveAs(Form("figs/RAA_JPsi_y1p6_2p4_Cent_260519v2_Sys%d_4Bins.pdf",isSys));
