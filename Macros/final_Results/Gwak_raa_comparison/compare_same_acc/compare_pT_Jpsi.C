...
void compare_pT_Jpsi(bool isSys = true)
{
  ...
  TGraphErrors *gSameAccMidPr = makePtGraph(jpsi_raa_same_acc::kPtMidBinEdges, jpsi_raa_same_acc::kTnPL2L3PtMidPr, jpsi_raa_same_acc::kTnPL2L3PtMidPrStat, jpsi_raa_same_acc::kNPtMid, !isSys);
  TGraphErrors *gSameAccFwdPr = makePtGraph(jpsi_raa_same_acc::kPtFwdBinEdges, jpsi_raa_same_acc::kTnPL2L3PtFwdPr, jpsi_raa_same_acc::kTnPL2L3PtFwdPrStat, jpsi_raa_same_acc::kNPtFwd, !isSys);
  TGraphErrors *gSameAccMidNp = makePtGraph(jpsi_raa_same_acc::kPtMidBinEdges, jpsi_raa_same_acc::kTnPL2L3PtMidNp, jpsi_raa_same_acc::kTnPL2L3PtMidNpStat, jpsi_raa_same_acc::kNPtMid, !isSys);
  TGraphErrors *gSameAccFwdNp = makePtGraph(jpsi_raa_same_acc::kPtFwdBinEdges, jpsi_raa_same_acc::kTnPL2L3PtFwdNp, jpsi_raa_same_acc::kTnPL2L3PtFwdNpStat, jpsi_raa_same_acc::kNPtFwd, !isSys);
  ...
  drawComparisonWithTwoCurrentsAndTwoOlds(gRun2MidPr, gSameAccMidPr, gHinMidPrAbsY0p6, gHinMidPrAbsY0p6Sys, gHinMidPrAbsY1p6, gHinMidPrAbsY1p6Sys,
                 "PR (Cent. 0-90%, |y| < 1.6)",
                 "PR (same Acc, Cent. 0-90%, |y| < 1.6)",
                 "PR (HIN-16-025, Cent. 0-100%, |y| < 0.6)",
                 "PR (HIN-16-025, Cent. 0-100%, |y| < 1.6)",
                 40.0, "compare_mid_pT_Jpsi_PR");
  drawComparisonWithTwoCurrentsAndTwoOlds(gRun2FwdPr, gSameAccFwdPr, gHinFwdPrAbsY1p8to2p4, gHinFwdPrAbsY1p8to2p4Sys, gHinFwdPrAbsY1p6to2p4, gHinFwdPrAbsY1p6to2p4Sys,
                 "PR (Cent. 0-90%, 1.6 < |y| < 2.4)",
                 "PR (same Acc, Cent. 0-90%, 1.6 < |y| < 2.4)",
  ...
  drawComparisonWithTwoCurrents(gRun2MidNp, gSameAccMidNp, gHinMidNpAbsY0p6, gHinMidNpAbsY0p6Sys,
                 "NP (Cent. 0-90%, |y| < 1.6)", "NP (same Acc, Cent. 0-90%, |y| < 1.6)", "NP (HIN-16-025, Cent. 0-100%, |y| < 0.6)",
                 40.0, "compare_mid_pT_Jpsi_NP");
  drawComparisonWithTwoCurrents(gRun2FwdNp, gSameAccFwdNp, gHinFwdNpAbsY1p8to2p4, gHinFwdNpAbsY1p8to2p4Sys,
                 "NP (Cent. 0-90%, 1.6 < |y| < 2.4)", "NP (same Acc, Cent. 0-90%, 1.6 < |y| < 2.4)", "NP (HIN-16-025, Cent. 0-100%, 1.8 < |y| < 2.4)",
