...
void drawComparisonWithTwoCurrents(TGraphErrors *gCurrent,
                                   TGraphErrors *gSameAcc,
                                   TGraphErrors *gOld, TGraphErrors *gOldSys,
                                   const char *legendCurrent, const char *legendSameAcc, const char *legendOld,
                                   const char *outName)
{
  TCanvas *c = new TCanvas(outName, "", 800, 800);
  c->cd();
  ...
  if (gOldSys)
    gOldSys->Draw("5");
  gCurrent->Draw("P SAME");
  gSameAcc->Draw("P SAME");

  TLegend *leg = new TLegend(0.42, 0.69, 0.90, 0.88);
  leg->SetBorderSize(0);
  leg->SetFillStyle(0);
  leg->SetTextFont(42);
  leg->SetTextSize(0.0175);
  leg->SetEntrySeparation(0.010);
  leg->AddEntry(gCurrent, legendCurrent, "pe");
  leg->AddEntry(gSameAcc, legendSameAcc, "pe");
  leg->AddEntry(gOld, legendOld, "pe");
  leg->Draw();
...
void drawComparisonWithTwoCurrentsAndTwoOlds(TGraphErrors *gCurrent,
                                             TGraphErrors *gSameAcc,
                                             TGraphErrors *gOldA, TGraphErrors *gOldASys,
                                             TGraphErrors *gOldB, TGraphErrors *gOldBSys,
                                             const char *legendCurrent, const char *legendSameAcc,
                                             const char *legendOldA, const char *legendOldB,
                                             const char *outName)
{
  TCanvas *c = new TCanvas(outName, "", 800, 800);
  ...
  TLegend *leg = new TLegend(0.42, 0.65, 0.90, 0.88);
  leg->SetBorderSize(0);
  leg->SetFillStyle(0);
  leg->SetTextFont(42);
  leg->SetTextSize(0.0175);
...
void drawComparisonWithTwoCurrentsAndThreeOlds(TGraphErrors *gCurrent,
                                               TGraphErrors *gSameAcc,
                                               TGraphErrors *gOldA, TGraphErrors *gOldASys,
                                               TGraphErrors *gOldB, TGraphErrors *gOldBSys,
                                               TGraphErrors *gOldC, TGraphErrors *gOldCSys,
                                               ...
                                               const char *outName)
{
  ...
  TLegend *leg = new TLegend(0.42, 0.57, 0.90, 0.88);
  leg->SetBorderSize(0);
  leg->SetFillStyle(0);
  leg->SetTextFont(42);
  leg->SetTextSize(0.0175);
...
void compare_Npart_Jpsi(bool isSys = true)
{
  ...
  TGraphErrors *gSameAccMidPr = makeCentGraph(jpsi_raa_same_acc::kMidNpart, jpsi_raa_same_acc::kMidNpartXErr, jpsi_raa_same_acc::kTnPL2L3CentMidPr, jpsi_raa_same_acc::kTnPL2L3CentMidPrStat, jpsi_raa_same_acc::kNCentMid, !isSys);
  TGraphErrors *gSameAccFwdPr = makeCentGraph(jpsi_raa_same_acc::kFwdNpart, jpsi_raa_same_acc::kFwdNpartXErr, jpsi_raa_same_acc::kTnPL2L3CentFwdPr, jpsi_raa_same_acc::kTnPL2L3CentFwdPrStat, jpsi_raa_same_acc::kNCentFwd, !isSys);
  TGraphErrors *gSameAccMidNp = makeCentGraph(jpsi_raa_same_acc::kMidNpart, jpsi_raa_same_acc::kMidNpartXErr, jpsi_raa_same_acc::kTnPL2L3CentMidNp, jpsi_raa_same_acc::kTnPL2L3CentMidNpStat, jpsi_raa_same_acc::kNCentMid, !isSys);
  TGraphErrors *gSameAccFwdNp = makeCentGraph(jpsi_raa_same_acc::kFwdNpart, jpsi_raa_same_acc::kFwdNpartXErr, jpsi_raa_same_acc::kTnPL2L3CentFwdNp, jpsi_raa_same_acc::kTnPL2L3CentFwdNpStat, jpsi_raa_same_acc::kNCentFwd, !isSys);
  ...
  styleGraph(gSameAccMidPr, kBlue + 3, 27);
  styleGraph(gSameAccFwdPr, kBlue + 3, 27);
  styleGraph(gSameAccMidNp, kOrange + 7, 27);
  styleGraph(gSameAccFwdNp, kOrange + 7, 27);
  ...
  drawComparisonWithTwoCurrentsAndTwoOlds(gRun2MidPr, gSameAccMidPr, gHinMidPrAbsY0p6, gHinMidPrAbsY0p6Sys, gHinMidPrAbsY1p6, gHinMidPrAbsY1p6Sys,
                 "PR (6.5 < p_{T} < 40, |y| < 1.6)",
                 "PR (same Acc, 6.5 < p_{T} < 40, |y| < 1.6)",
                 "PR (HIN-16-025, 6.5 < p_{T} < 50, |y| < 0.6)",
                 "PR (HIN-16-025, 6.5 < p_{T} < 30, |y| < 1.6)",
                 "compare_mid_Npart_Jpsi_PR");
  drawComparisonWithTwoCurrentsAndThreeOlds(gRun2FwdPr, gSameAccFwdPr, gHinFwdPrAbsY1p8to2p4, gHinFwdPrAbsY1p8to2p4Sys, gHinFwdPrLowPtAbsY1p8to2p4, gHinFwdPrLowPtAbsY1p8to2p4Sys, gHinFwdPrAbsY1p6to2p4, gHinFwdPrAbsY1p6to2p4Sys,
                 "PR (3.5 < p_{T} < 40, 1.6 < |y| < 2.4)",
                 "PR (same Acc, 3.5 < p_{T} < 40, 1.6 < |y| < 2.4)",
  ...
  drawComparisonWithTwoCurrents(gRun2MidNp, gSameAccMidNp, gHinMidNpAbsY0p6, gHinMidNpAbsY0p6Sys,
                 "NP (6.5 < p_{T} < 40, |y| < 1.6)", "NP (same Acc, 6.5 < p_{T} < 40, |y| < 1.6)", "NP (HIN-16-025, 6.5 < p_{T} < 50, |y| < 0.6)",
                 "compare_mid_Npart_Jpsi_NP");
  drawComparisonWithTwoCurrentsAndTwoOlds(gRun2FwdNp, gSameAccFwdNp, gHinFwdNpAbsY1p8to2p4, gHinFwdNpAbsY1p8to2p4Sys, gHinFwdNpLowPtAbsY1p8to2p4, gHinFwdNpLowPtAbsY1p8to2p4Sys,
                 "NP (3.5 < p_{T} < 40, 1.6 < |y| < 2.4)",
                 "NP (same Acc, 3.5 < p_{T} < 40, 1.6 < |y| < 2.4)",
