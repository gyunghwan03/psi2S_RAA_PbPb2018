...
void draw_Raa_JPsi_y1p6_2p4_Cent_241223(bool isSys=true)
{
    ...
    TFile *fEff_ppPR = new TFile("../../Eff_Acc/roots/mc_eff_vs_pt_rap_prompt_pp_Jpsi_PtW1_tnp1_20241017.root");
    TFile *fEff_ppNP = new TFile("../../Eff_Acc/roots/mc_eff_vs_pt_rap_nprompt_pp_Jpsi_PtW1_tnp1_20241017.root"); //Must Change
	...
	double centBin[nCentBins+1] = {0,10,20,30,50,90};
	...
	double NpartBin[nCentBins] = {27.12,109.1,188.2,262.3,356.9};
	...
	double Taa[nCentBins]     = {23.05, 14.39, 8.798, 3.950, 0.5803};
    double Taa_err[nCentBins] = { 0.42,   0.3, 0.219, 0.132, 0.0288};
...
*/
	...
	cXPR->SaveAs("figs/CrossSection_JPsi_PR_y1p6_2p4_Cent_241223.pdf");
	...
	cXNP->SaveAs("figs/CrossSection_JPsi_NP_y1p6_2p4_Cent_241223.pdf");
	...
	cRAA->SaveAs(Form("figs/RAA_JPsi_y1p6_2p4_Cent_Sys%d_241223.pdf",isSys));

	TFile *f1 = new TFile("roots/RAA_JPsi_forRap_Npart_241223.root","recreate");
	f1->cd();
	hRAA_PR->Write();
	hRAA_NP->Write();
	f1->Close();
...
valErr getYield_PbPb(int i){
    double centBin[6] = {0,20,40,60,100,180};//{0,20,40,60,80,100,180};
    TString kineLabel[6];
