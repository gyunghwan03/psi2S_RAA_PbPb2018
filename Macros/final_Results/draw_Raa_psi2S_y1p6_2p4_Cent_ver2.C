...
void draw_Raa_psi2S_y1p6_2p4_Cent_ver2()
{
...
*/
	...
	cXNP->SaveAs("./figs/CrossSection_NP_y1p6_2p4_Cent_ver2.pdf");
	...
	cRAA->SaveAs("./figs/RAA_psi2S_y1p6_2p4_Cent_ver2.pdf");

	TFile *f1 = new TFile("./roots/RAA_psi2S_forRap_Npart_ver2.root","recreate");
	f1->cd();
	hRAA_PR->Write();
	hRAA_NP->Write();
	f1->Close();
