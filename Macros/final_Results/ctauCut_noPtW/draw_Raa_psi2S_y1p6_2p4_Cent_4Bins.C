...
void draw_Raa_psi2S_y1p6_2p4_Cent_4Bins(bool isSys=true)
{
	...
	TFile *fEff_PbPbPR = new TFile("../../../Eff_Acc_260203/roots/mc_eff_vs_pt_cent_0_to_180_rap_prompt_pbpb_psi2S_PtW1_tnp1_ctauCut_260323_2exp_noPtW.root");
	TFile *fEff_PbPbNP = new TFile("../../../Eff_Acc_260203/roots/mc_eff_vs_pt_cent_0_to_180_rap_nprompt_pbpb_psi2S_PtW1_tnp1_ctauCut_260323_2exp_noPtW.root");
    TFile *fEff_ppPR = new TFile("../../../Eff_Acc_260203/roots/mc_eff_vs_pt_rap_prompt_pp_psi2S_PtW1_tnp1_ctauCut_260323_noPtW.root");
    TFile *fEff_ppNP = new TFile("../../../Eff_Acc_260203/roots/mc_eff_vs_pt_rap_nprompt_pp_psi2S_PtW1_tnp1_ctauCut_260323_noPtW.root");
    ...
    //TH1D *hEff_PbPbPR = (TH1D*) fEff_ppPR -> Get("mc_eff_Integrated_TnP1_PtW1_absy1p6_2p4");
    //TH1D *hEff_PbPbNP = (TH1D*) fEff_ppNP -> Get("mc_eff_Integrated_TnP1_PtW1_absy1p6_2p4");
...
*/
	...
	cXPR->SaveAs(Form("figs/CrossSection_PR_y1p6_2p4_Cent_pt3p5_40_4Bins.pdf"));
	...
	cXNP->SaveAs(Form("figs/CrossSection_NP_y1p6_2p4_Cent_pt3p5_40_4Bins.pdf"));
	...
	drawText(Form("3.5 < p_{T} < 40 GeV/c"), pos_x, pos_y, text_color, text_size);
	drawText("1.6 < |y| < 2.4", pos_x, pos_y-pos_y_diff, text_color, text_size);
	...
	cRAA->SaveAs(Form("figs/RAA_psi2S_y1p6_2p4_Cent_Sys%d_pt3p5_40_4Bins.pdf",isSys));

	TFile *f1 = new TFile(Form("roots/RAA_psi2S_forRap_Npart_pt3p5_40_4Bins.root"),"recreate");
	f1->cd();
	hRAA_PR->Write();
	hRAA_NP->Write();
	hfwdPR_int->Write();
