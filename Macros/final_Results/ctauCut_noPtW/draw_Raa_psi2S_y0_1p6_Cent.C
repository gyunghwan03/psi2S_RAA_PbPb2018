...
*/
	...
	double Xpp_PR_int = lumi_pp_scale * yieldPP_PR_corr / (lumi_pp*1e+2*(double)(40.-6.5)*2*(double)(1.6-0.0));
	double Xpp_NP_int = lumi_pp_scale * yieldPP_NP_corr / (lumi_pp*1e+2*(double)(40.-6.5)*2*(double)(1.6-0.0));
	double XPbPb_PR_int = yieldPbPb_PR_corr / (Nmb*Taa_int*(double)(40.-6.5)*(double)2*(1.6-0.0));
	double XPbPb_NP_int = yieldPbPb_NP_corr / (Nmb*Taa_int*(double)(40.-6.5)*(double)2*(1.6-0.0));
	...
	// Add integrated RAA values for pT 6.5-40
