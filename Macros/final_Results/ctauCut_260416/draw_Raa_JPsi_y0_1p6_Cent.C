...
void draw_Raa_JPsi_y0_1p6_Cent(bool isSys=false)
{
    ...
    TH1D *hEff_PbPbPR_Integrated = (TH1D*) fEff_PbPbPR -> Get("mc_eff_Integrated_TnP1_PtW1_cent_0_to_180_absy0_1p6");
    TH1D *hEff_PbPbNP_Integrated = (TH1D*) fEff_PbPbNP -> Get("mc_eff_Integrated_TnP1_PtW1_cent_0_to_180_absy0_1p6");
...
*/
	...
	cRAA->SaveAs(Form("./figs/RAA_JPsi_y0_1p6_Npart_Sys%d.pdf",isSys));
...
//	if(isPR==0) PR = "PRMC";
//	else if(isPR==1) PR = "NPMC";
//	TFile* f_ctau = new TFile(Form("../../../ctau_eff/roots_1S_pp/decayL/%s/decay_hist_%s_m2.6-3.5.root",PR.Data(), kineLabel.Data()));
...
//	else if(isPR==1) PR = "NPMC";
//	kineLabel[i] = getKineLabel(6.5,40,0,1.6,0.0,centBin[i],centBin[i+1]);
//	TFile* f_ctau = new TFile(Form("../../../ctau_eff/roots_1S_Pb/decayL/PRMC/decay_hist_%s_m2.6-3.5.root",kineLabel[i].Data()));
//	TH1D* h_ctau = (TH1D*)f_ctau->Get("h_eff");
//	valErr ret;
//	ret.val = h_ctau->GetBinContent(1);
//	ret.err = h_ctau->GetBinError(1);
