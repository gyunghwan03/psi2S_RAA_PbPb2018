...
void draw_Raa_JPsi_y0_1p6_pT_241014(bool isSys = true)
{
	//gROOT->SumW2();
	gStyle->SetOptStat(0);
	setTDRStyle();
	...
	cXPR->SaveAs("./figs/CrossSection_JPsi_PR_y0_1p6_pT.pdf");
	...
	cXNP->SaveAs("./figs/CrossSection_JPsi_NP_y0_1p6_pT.pdf");
	...
	cRAA->SaveAs(Form("./figs/RAA_JPsi_y0_1p6_pT_Sys%d.pdf",isSys));
