...
void draw_Raa_psi2S_y1p6_2p4_pT_ver2()
{
    ...
    TFile *fAcc_PbPb = new TFile("../../Eff_Acc/roots/acceptance_Prompt_psi2s_GenOnly_wgt1_PbPb_SysUp0_20230601.root");
    TFile *fAcc_pp = new TFile("../../Eff_Acc/roots/acceptance_Prompt_psi2s_GenOnly_wgt1_pp_SysUp0_20230602.root");
	...
	for(int i=0;i<nPtBins;i++)
    {
		...
		cout << "PbPb Yield	: " << yieldPbPb.val << ", yield Err : " << err1_PbPb << ", b frac : " << fracPbPb.val << ", frac Err : " << err2_PbPb << ",	Eff PR : " << eff_PbPbPR << ",	Eff NP : " << eff_PbPbNP << ", Acc : " << acc_PbPb << endl;
	    cout << "pp Yield	: " << yieldPP.val << ", yield Err : " << err1_PP << ", b frac : " << fracPP.val << ", frac Err : " << err2_PP << ",	Eff PR : " << eff_ppPR << ",	Eff NP : " << eff_ppNP <<  ", Acc : " << acc_pp << endl;
	...
	cXPR->SaveAs("./figs/CrossSection_PR_y1p6_2p4_pT_ver2.pdf");
	...
	cXNP->SaveAs("./figs/CrossSection_NP_y1p6_2p4_pT_ver2.pdf");
	...
	cRAA->SaveAs("./figs/RAA_psi2S_y1p6_2p4_pT_ver2.pdf");

	TFile *f1 = new TFile("./roots/RAA_psi2S_forRap_pT_ver2.root","recreate");
	f1->cd();
	hRAA_PR->Write();
	hRAA_NP->Write();
	f1->Close();
...
valErr getYield_pp(int i){
    double ptBins[5] = {3.5,5,6.5,12,50};
    TString kineLabel[5];
...
valErr getFrac_PbPb(int i) {
    double ptBin[5] = {3.5,5,6.5,12,50};
    TString kineLabel[5];
