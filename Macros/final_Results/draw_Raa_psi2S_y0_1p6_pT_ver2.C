...
void draw_Raa_psi2S_y0_1p6_pT_ver2() // add Non Prompt Efficiency of pp
{
	...
	//TFile *fEff_ppPR = new TFile("../Eff_Acc/roots/mc_eff_vs_pt_rap_prompt_pp_psi2s_PtW1_tnp1_20230607.root");
	...
	for(int i=0;i<nPtBins;i++)
	{
		...
		cout << "PbPb Yield :	" << yieldPbPb.val << ",	b frac : " << fracPbPb.val  << ",	b frac err : " << err2_PbPb << ",		PR Eff : " << eff_PbPbPR << ",	NP Eff : " << eff_PbPbNP<< ",	Acc : " << acc_PbPb << endl;
		cout << "pp Yield :	" << yieldPP.val << ",	b frac : " << fracPP.val << ",	b frac err : " << err2_PP <<  ",	pp PR Eff : " << eff_ppPR << ",	pp NP Eff : "  << eff_ppNP << ",	Acc : " << acc_pp << endl;
	...
	cXPR->SaveAs("./figs/CrossSection_PR_y0_1p6_pT_ver2.pdf");
	...
	cXNP->SaveAs("./figs/CrossSection_NP_y0_1p6_pT_ver2.pdf");
	...
	cRAA->SaveAs("./figs/RAA_psi2S_y0_1p6_pT_ver2.pdf");
	cRAA->SaveAs("./figs/RAA_psi2S_y0_1p6_pT_ver2.png");

	TFile *outFile = new TFile("./roots/RAA_psi2S_midRap_pT_ver2.root","recreate");
	hRAA_PR->Write();
	hRAA_NP->Write();
	outFile->Close();
