...
//  f1 = new TFile("/Users/hwan/tools/2019/CMS/JPsi/Jpsi_v2_PbPb2018/skimmedFiles/vnCut/OniaRooDataSet_isMC0_JPsi_pt3.0-4.5_y1.6-2.4_muPt0.0_centrality20-120_m2.6-3.5_OS_Effw0_Accw0_PtW1_TnP1_211110.root");
  ...
  double paramsupper[6] = {10., 10., 0.13, 3., 1., 25.0};

  
  if(ptLow==3.5&&ptHigh==6.5) paramsupper[2] = 0.15;
  ...
  if(ptLow==20&&ptHigh==25&&PRw==1) NJpsi_limit = 2000;
  else if(ptLow==20&&ptHigh==25&&PRw==2) NJpsi_limit = 3000;
  ...
  RooProdPdf model("model","model with constraint",RooArgSet(*pdfMASS_Jpsi,RooArgSet(x_constraint,sigma1_constraint)));
