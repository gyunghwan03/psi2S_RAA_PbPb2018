...
void mc_MassFit_pT3p0_4p5_y_1p6_2p4_cent_0_180(
		...
		)
{
	...
	// MC
	TFile* f1 = new TFile("../../../skimmedFiles/OOniaRooDataSet_isMC1_Psi2S_pp_y0.00_2.40_Effw0_Accw0_PtW0_TnP0_230517.root", "read");
	...
	TString kineCut;
	kineCut = Form("pt>%.2f && pt<%.2f && abs(y)>%.2f && abs(y)<%.2f && mass>3.4 && mass<4.",ptLow, ptHigh, yLow, yHigh);
    ...
    sigma_up=0.4; x_up=4; alpha_up=3; n_up=5; f_up=1;
