...
void mc_MassFit_pT4p0_5p0_y_1p6_2p4_cent_0_180(
		float ptLow=4.0, float ptHigh=5.0,
		...
		)
{
    ...
    sigma_up=0.1; x_up=4; alpha_up=3; n_up=5; f_up=1;
    ...
    double N_Jpsi_high = 4.5e+5, N_Bkg_high = 10000;
