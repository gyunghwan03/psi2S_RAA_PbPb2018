    ...
    )
{
  ...
  ws->factory("b_Bkg[0.9, 1e-6., 1.]");//NP fraction for bkg
  ws->factory("fDFSS[0.7, 1e-6., 1]"); // Should be 0 - 1. Give 10 to make some room
  ws->factory("fDLIV[0.5, 1e-6., 1]"); // Should be 0 -1
