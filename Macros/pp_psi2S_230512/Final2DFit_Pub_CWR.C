    ...
    )
{
  ...
  f1 = new TFile(Form("../../skimmedFiles/OniaRooDataSet_isMC0_Psi2S_pp_y0.00_2.40_Effw0_Accw0_PtW0_TnP0_221117.root"));
  ...
  RooDataSet *dsTot = (RooDataSet*)datasetWo->reduce(RooArgSet(*(ws->var("ctau3DRes")),*(ws->var("ctau3D")), *(ws->var("ctau3DErr")), *(ws->var("mass")), *(ws->var("pt")), *(ws->var("y"))), Form("ctau3DErr>=%.6f&&ctau3DErr<=%.6f&&%s", ctauErrMin, ctauErrMax, kineCut.Data()) );
  ...
  if(ptLow==3&&ptHigh==4.5) ws->factory("b_Jpsi[0.14, 1e-8, 1.0]");//NP fraction for Sig
  else if(ptLow==6.5&&ptHigh==9) ws->factory("b_Jpsi[0.24, 0.22, 0.26]");//NP fraction for Sig
  ...
  myPlot2_H->GetXaxis()->SetRangeUser(3.3, 4.1);
  ...
  ofstream of1(Form("figs/2DFit_%s/Final_Paper_CWR/2DFit_Ctau_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_Left.txt", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP));
  ofstream of2(Form("figs/2DFit_%s/Final_Paper_CWR/2DFit_Ctau_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_Righ.txt", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP));
  ofstream of3(Form("figs/2DFit_%s/Final_Paper_CWR/2DFit_Ctau_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d_Cent.txt", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP));
  ...
  c_G->Update();
  c_G->SaveAs(Form("figs/2DFit_%s/Final_Paper_CWR/2DFit_Ctau_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d.pdf", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP));
  c_H->Update();
  c_H->SaveAs(Form("figs/2DFit_%s/Final_Paper_CWR/2DFit_Mass_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d.pdf", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP));
  c_H_2->SaveAs(Form("figs/2DFit_%s/Final_Paper_CWR/Pull_Mass_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d.pdf", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP));
  ...
  fitResult->Print("v");
  TFile *outFile = new TFile(Form("roots/2DFit_%s/Final_Paper_CWR/2DFitResult_%s_%sw_Effw%d_Accw%d_PtW%d_TnP%d.root", DATE.Data(), kineLabel.Data(), fname.Data(), fEffW, fAccW, isPtW, isTnP),"recreate");
