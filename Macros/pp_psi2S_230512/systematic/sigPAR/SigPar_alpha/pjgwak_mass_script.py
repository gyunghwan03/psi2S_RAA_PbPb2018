...
#subprocess.call("root -l MassFit_FixPar_Data.C'(3, 6.5, 1.6, 2.4)'", shell=True)
#subprocess.call("root -l MassFit_FixPar_Data.C'(6.5, 12, 1.6, 2.4)'", shell=True)
#subprocess.call("root -l MassFit_FixPar_Data.C'(12, 50, 1.6, 2.4)'", shell=True)

#subprocess.call("root -l MassFit_FixPar_Data.C'(3, 50, 1.6, 2.4)'", shell=True)
...
#subprocess.call("root -l MassFit_FixPar_Data.C'(20, 50, 0, 1.6)'", shell=True)

#subprocess.call("root -l MassFit_FixPar_Data.C'(6.5, 50, 0, 1.6)'", shell=True)


#subprocess.call("root -l Final2DFit.C'(3, 6.5, 1.6, 2.4)'", shell=True)
...
#subprocess.call("root -l Final2DFit.C'(3, 50, 1.6, 2.4)'", shell=True)
...
#subprocess.call("root -l Final2DFit.C'(20, 50, 0, 1.6)'", shell=True)
