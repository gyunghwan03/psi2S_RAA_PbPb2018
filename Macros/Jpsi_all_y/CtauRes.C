    ...
    )
{
  ...
  //if(ptLow>=15 && cHigh==20) nGauss = 2;
  if(cLow==30 && cHigh==40) nGauss = 2;
  if(cLow>=120) nGauss = 2;
  ...
  //ws->factory("rS21_CtauRes[1.1, 1e-6, 3.0]");
  //ws->factory("rS32_CtauRes[2.3, 1e-6, 5.0]");
  ...
  //ws->factory("f_CtauRes[0.1, 1e-4, 1.]");
  //ws->factory("f2_CtauRes[0.1, 1e-4, 1.]");
  ...
  ws->factory("rS21_CtauRes[1.32, 1e-6, 3.0]");
  ws->factory("rS32_CtauRes[2.37, 1e-6, 5.0]");
  ws->factory("f_CtauRes[0.584, 1e-5, 1.]");
  ...
  ws->factory("s1_CtauRes[0.5, 1e-6, 1.0]");
  ws->factory("rS21_CtauRes[1.15, 1e-6, 3.0]");
  ws->factory("rS32_CtauRes[2.73, 1e-6, 5.0]");
  ws->factory("f_CtauRes[0.53, 1e-4, 1.]");
  ws->factory("f2_CtauRes[0.371, 1e-4, 1.]");}

  else if(ptLow==8.5 && ptHigh==9.5){
  ws->factory("s1_CtauRes[0.5, 1e-4, 1.0]");
  ws->factory("rS21_CtauRes[1.15, 1e-4, 3.0]");
  ws->factory("rS32_CtauRes[2.37, 1e-4, 5.0]");
  ws->factory("f_CtauRes[0.33, 1e-4, 1.]");
  ws->factory("f2_CtauRes[0.372, 1e-4, 1.]");}

  else if(ptLow==9.5 && ptHigh==11){
  ws->factory("s1_CtauRes[0.5, 1e-4, 1.0]");
  ws->factory("rS21_CtauRes[1.15, 1e-6, 3.0]");
  ws->factory("rS32_CtauRes[2.87, 1e-6, 5.0]");
  ws->factory("f_CtauRes[0.92, 1e-4, 1.]");
  //ws->factory("f_CtauRes[0.93, 1e-4, 1.]");
  ws->factory("f2_CtauRes[0.34, 1e-4, 1.]");}
  //ws->factory("f2_CtauRes[0.32, 1e-4, 1.]");}
  ...
  ws->factory("rS21_CtauRes[1.15, 1e-6, 3.0]");
  ws->factory("rS32_CtauRes[2.87, 1e-6, 5.0]");
  ws->factory("f_CtauRes[0.91, 1e-4, 1.]");
  //ws->factory("f_CtauRes[0.93, 1e-4, 1.]");
  ws->factory("f2_CtauRes[0.35, 1e-4, 1.]");}

  else if(ptLow>=15 && ptHigh<=20){
  ws->factory("s1_CtauRes[0.5, 1e-4, 1.0]");
  ws->factory("rS21_CtauRes[1.15, 1e-4, 3.0]");
  ws->factory("rS32_CtauRes[2.87, 1e-6, 5.0]");
  ws->factory("f_CtauRes[0.3, 1e-4, 1.]");
  ws->factory("f2_CtauRes[0.35, 1e-4, 1.]");}

  else if(ptLow>=20 && ptHigh<=50){
  ws->factory("s1_CtauRes[0.5, 1e-4, 1.0]");
  //ws->factory("rS21_CtauRes[1.15, 1e-4, 3.0]");
  ws->factory("rS21_CtauRes[3.514, 1e-4, 4.0]");
  ws->factory("rS32_CtauRes[2.87, 1e-6, 5.0]");
  ws->factory("f_CtauRes[0.155, 1e-4, 1.]");
  //ws->factory("f_CtauRes[0.8055, 1e-6, 1.]");
  ws->factory("f2_CtauRes[0.35, 1e-4, 1.]");}
...
//  if (v2==-0.3&&ptLow==6.5&&ptHigh==7.5) ctauResMin=-6.4;
  ...
  if(ptLow==9.5&&ptHigh==11) ctauResMin = -7.5;
  if(ptLow==13&&ptHigh==15) ctauResMin = -8.5;
  if(ptLow==27.5&&ptHigh==30) ctauResMin = -3.5;
  if(ptLow==30&&ptHigh==40) ctauResMin = -1.5;
  if(ptLow==30&&ptHigh==50) ctauResMin = -2.8;
  if(ptLow==6.5&&cLow==0&&cHigh==180) ctauResMin = -9.1;
  if(ptLow==15.&&cLow==0&&cHigh==180) ctauResMin = -5.6;
