...
//  RooBinning bins(nBins, ctauErrLow, ctauErrHigh);
  ...
  //ctauErrMin=0.019;
  ctauErrMax=0.1203;
  if(ptLow>=6.5&&ptHigh<=8.5) ctauErrMax=0.1008;
  if(ptLow==8.5&&ptHigh==9.5) ctauErrMax=0.0942;
  if(ptLow==9.5&&ptHigh==11.) ctauErrMax=0.0878;
  if(ptLow==11.&&ptHigh==13.) ctauErrMax=0.0824;
  if(ptLow==13.&&ptHigh==15.) ctauErrMax=0.0749;
  if(ptLow==15.&&ptHigh==17.5) ctauErrMax=0.0539;
  if(ptLow==17.5&&ptHigh==20.) ctauErrMax=0.046;
  if(ptLow==20.&&ptHigh==22.5) ctauErrMax=0.0352;
  if(ptLow==22.5&&ptHigh==25.) ctauErrMax=0.037;
  if(ptLow==25.&&ptHigh==27.5) ctauErrMax=0.0334;
  if(ptLow==27.5&&ptHigh==30.) ctauErrMax=0.027;
  if(ptLow==30.&&ptHigh==40.) ctauErrMax=0.027;
  if(ptLow==40.&&ptHigh==50.) ctauErrMax=0.027;
  if(ptLow==6.5&&ptHigh==40&&cLow==110) ctauErrMax=0.09647;
  if(ptLow==6.5&&ptHigh==40&&cLow==0&&cHigh==180) ctauErrMax=0.135;
  ...
  if(ptLow==6.5&&ptHigh==50&&cLow==100) ctauErrMax=0.0589;
  if(ptLow==6.5&&ptHigh==50&&cLow==110) ctauErrMax=0.05421;
  if(ptLow==6.5&&ptHigh==50&&cLow==120) ctauErrMax=0.0514;
  if(ptLow==6.5&&ptHigh==50&&cLow==130) ctauErrMax=0.051;
  if(ptLow==6.5&&ptHigh==50&&cLow==140) ctauErrMax=0.04448;
  if(ptLow==12&&ptHigh==40) ctauErrMax=0.0664;
  if(ptLow==25&&ptHigh==40) ctauErrMax=0.0336;
  if(ptLow==3&&cLow==100&&cHigh==180) ctauErrMax=0.1201;//0.1238;
