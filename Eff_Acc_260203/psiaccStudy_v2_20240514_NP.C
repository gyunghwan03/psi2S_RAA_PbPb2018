...
void psiaccStudy_v2_20240514_NP(int wtopt=1, int isPtWgtUp = 0, TString rmk="20230416")
{
  ...
  TFile *wf = new TFile(Form("./roots/acceptance_NonPrompt_psi2s_GenOnly_wgt%d_%s_SysUp%d_20240514.root",wtopt,"pp",isPtWgtUp),"RECREATE");
  wf->cd();
