...
void plot_efficiency_ptweight_compare_jpsi_pp(int state = 1) {
  ...
  const TString filePtW = isPrompt
                              ? "./roots/mc_eff_vs_pt_rap_prompt_pp_Jpsi_PtWnomi_tnp1_ctauCut_260316_2exp.root"
                              : "./roots/mc_eff_vs_pt_rap_nprompt_pp_Jpsi_PtWnomi_tnp1_ctauCut_260316_2exp.root";

  const TString fileNoPtW = isPrompt
                                ? "./roots/mc_eff_vs_pt_rap_prompt_pp_Jpsi_PtWnomi_tnp1_ctauCut_260316_2exp_noPtW.root"
                                : "./roots/mc_eff_vs_pt_rap_nprompt_pp_Jpsi_PtWnomi_tnp1_ctauCut_260316_2exp_noPtW.root";
