...
void get_Eff_Jpsi_pp_ctauCut_v4_noPtW(
  int state=1,
...
//draw same
  ...
  hpt_eff_0 ->SetName(Form("mc_eff_vs_pt_TnP%d_PtW%d_absy0_2p4",isTnP, 0));
  hpt_eff_1 ->SetName(Form("mc_eff_vs_pt_TnP%d_PtW%d_absy1p6_2p4",isTnP, 0));
  hpt_eff_2 ->SetName(Form("mc_eff_vs_pt_TnP%d_PtW%d_absy0_1p6",isTnP, 0));
  hInt_eff_1 ->SetName(Form("mc_eff_Integrated_TnP%d_PtW%d_absy1p6_2p4",isTnP, 0));
  hInt_eff_2 ->SetName(Form("mc_eff_Integrated_TnP%d_PtW%d_absy0_1p6",isTnP, 0));
