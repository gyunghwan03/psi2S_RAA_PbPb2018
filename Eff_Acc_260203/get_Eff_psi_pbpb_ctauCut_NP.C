...
void get_Eff_psi_pbpb_ctauCut_NP(
  ...
  //input files
  //PbPb
  TString inputMC1 = "/data/Oniatree/miniAOD/OniaTree_Run2_PbPb2018MC_BToPsi_forPsi2S_miniAOD112X_muonSelGlb_13May23v2.root";
...
//draw same
  ...
  TString outFileName = Form("./roots/mc_eff_vs_pt_cent_%0.0f_to_%0.0f_rap_prompt_pbpb_psi2s_PtW%d_tnp%d_ctauCut_20251103.root",cLow,cHigh,isPtWeight,isTnP);
  if(state==2) outFileName = Form("./roots/mc_eff_vs_pt_cent_%0.0f_to_%0.0f_rap_nprompt_pbpb_psi2S_PtW%d_tnp%d_ctauCut_251103.root",cLow,cHigh,isPtWeight,isTnP);
