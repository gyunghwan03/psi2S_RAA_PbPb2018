...
void get_Eff_psi_pp_ctauCut_v3(
  int state=1,
...
//  TH2D* hpt_tnp_trig = new TH2D("hpt_tnp_trig","hpt_tnp_trig",numBins,ptBin,40,0,2);
  ...
  TString outFileName = Form("./roots/mc_eff_vs_pt_rap_prompt_pp_psi2S_PtW%d_tnp%d_ctauCut_260223.root",isPtWeight,isTnP);
  if(state==2) outFileName = Form("./roots/mc_eff_vs_pt_rap_nprompt_pp_psi2S_PtW%d_tnp%d_ctauCut_260223.root",isPtWeight,isTnP);
