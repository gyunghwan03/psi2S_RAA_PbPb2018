...
//draw same
  ...
  //if (state == 2)
  TString  outFileName;
  if(state==1) outFileName = Form("./roots/mc_eff_vs_pt_rap_prompt_pp_Jpsi_PtW%s_tnp%d_ctauCut_260126.root", ptSys.Data(), isTnP);
  else if(state==2) outFileName = Form("./roots/mc_eff_vs_pt_rap_nprompt_pp_Jpsi_PtW%s_tnp%d_ctauCut_260126.root", ptSys.Data(), isTnP);
