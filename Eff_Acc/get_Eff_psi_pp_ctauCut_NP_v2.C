...
using namespace std;
// v2 : add ctau cut for non-prompt psi(2S) in pp

void get_Eff_psi_pp_ctauCut_NP_v2(
...
//  TH2D* hpt_tnp_trig = new TH2D("hpt_tnp_trig","hpt_tnp_trig",numBins,ptBin,40,0,2);
  ...
  hpt_eff_1->Draw("E");
  lt1->SetTextSize(0.03);
  lt1->DrawLatex(0.13,0.84,"Non-Prompt #psi(2S) (pp)");
  ...
  TString outFileName = Form("./roots/mc_eff_vs_pt_rap_nprompt_pp_psi2S_PtW%d_tnp%d_ctauCut_260126.root",isPtWeight,isTnP);
